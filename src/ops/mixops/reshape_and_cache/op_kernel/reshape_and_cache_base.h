...
#include "mixops/reshape_and_cache/tiling/reshape_and_cache_tiling_dependency.h"
...
inline __aicore__ void InitTilingData(const __gm__ uint8_t *p_tilingdata, ReshapeAndCacheTilingData *tilingdata)
{
