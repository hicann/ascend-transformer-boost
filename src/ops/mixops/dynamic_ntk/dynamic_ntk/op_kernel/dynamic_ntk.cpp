...
#include "mixops/dynamic_ntk/dynamic_ntk/tiling/tiling_data.h"
#include "mixops/utils/common/kernel/kernel_utils.h"
#include "dynamic_ntk_calc.h"


inline __aicore__ void InitTilingData(const __gm__ uint8_t *p_tilingdata, AtbOps::DynamicNTKTilingData *tilingdata)
{
    ...
    CopyGmTilingToUb(tilingdata_in_ub, p_tilingdata, sizeof(AtbOps::DynamicNTKTilingData), &pipe);
...
#define GET_TILING_DATA(tiling_data, tiling_arg)    \
    AtbOps::DynamicNTKTilingData tiling_data;      \
                                                  ...
                                                  GM_ADDR tiling)
{
    ...
    const AtbOps::DynamicNTKTilingData *__restrict tilingData = &tilingDataIn;
