...
Status FlashAttentionNzPrecInfoCheck(UnpadFlashAttentionNzInfo &mmInfo, const LaunchParam &launchParam)
{
    ...
    OpParam::UnpadFlashAttentionNz &param)
{
    ...
    mmInfo.precType = param.precType;
    OP_TILING_CHECK_STATUS_RETURN(FlashAttentionNzPrecInfoCheck(mmInfo, launchParam));
