...
#include "mixops/activation/faster_gelu_forward/tiling/tiling_data.h"
#include "mixops/utils/common/kernel/kernel_utils.h"

using namespace AscendC;
constexpr uint32_t BUFFER_NUM = AtbOps::FASTER_GELU_FORWARD_BUFF_NUM;
...
public:
    ...
    __aicore__ inline ~FasterGeluForward() {}
    __aicore__ inline void Init(GM_ADDR inputAddr, GM_ADDR outAddr, AtbOps::FasterGeluForwardTilingData &tilingData)
    {
