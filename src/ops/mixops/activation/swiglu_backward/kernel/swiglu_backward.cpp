...
#include "mixops/activation/swiglu_backward/tiling/tiling_data.h"
...
inline __aicore__ void InitTilingData(const __gm__ uint8_t *p_tilingdata, SwiGluBackwardTilingData *tilingdata)
{
    ...
    CopyGmTilingToUb(tilingdata_in_ub, p_tilingdata, sizeof(AtbOps::SwiGluBackwardTilingData), &pipe);
