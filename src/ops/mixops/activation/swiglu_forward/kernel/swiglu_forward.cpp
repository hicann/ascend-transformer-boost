...
inline __aicore__ void InitTilingData(const __gm__ uint8_t *p_tilingdata, AtbOps::SwiGluForwardTilingData *tilingdata)
{
    ...
    CopyGmTilingToUb(tilingdata_in_ub, p_tilingdata, sizeof(AtbOps::SwiGluForwardTilingData), &pipe);
...
#define GET_TILING_DATA(tiling_data, tiling_arg)                                                                 \
    AtbOps::SwiGluForwardTilingData tiling_data;                                                                       \
