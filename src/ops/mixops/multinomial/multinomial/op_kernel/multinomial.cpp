...
#include "mixops/multinomial/multinomial/tiling/tiling_data.h"
...
inline __aicore__ void InitTilingData(const __gm__ uint8_t *p_tilingdata, AtbOps::MultinomialTilingData *tilingdata)
{
    ...
    CopyGmTilingToUb(tilingdata_in_ub, p_tilingdata, sizeof(AtbOps::MultinomialTilingData), &pipe);
    AscendC::PipeBarrier<PIPE_ALL>();
...
#define GET_TILING_DATA(tiling_data, tiling_arg)    \
    AtbOps::MultinomialTilingData tiling_data;      \
