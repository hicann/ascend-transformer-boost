...
#include "mixops/index/add_valid/tiling/tiling_data.h"
...
inline __aicore__ void InitTilingData(const __gm__ uint8_t *p_tilingdata, AtbOps::IndexAddValidTilingData *tilingdata)
{
...
#define GET_TILING_DATA(tiling_arg, tiling_data)                                                            \
    AtbOps::IndexAddValidTilingData tiling_data;                                                            \
