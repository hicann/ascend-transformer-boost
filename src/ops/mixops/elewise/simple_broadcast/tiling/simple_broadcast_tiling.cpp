...
{
    auto tilingData = reinterpret_cast<AtbOps::BroadcastTilingData *>(kernelInfo.GetTilingHostAddr());
    ...
    // 仅910B支持非32字节对齐
    if (AtbOps::PlatformInfo::Instance().GetPlatformType() != AtbOps::PlatformType::ASCEND_910B) {
