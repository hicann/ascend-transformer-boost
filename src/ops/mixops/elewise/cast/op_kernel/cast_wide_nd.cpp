...
inline __aicore__ void InitTilingData(const __gm__ uint8_t *p_tilingdata, AtbOps::CastTilingData *tilingData)
{
    ...
    CopyGmTilingToUb(tilingdata_in_ub, p_tilingdata, sizeof(AtbOps::CastTilingData), &pipe);
    AscendC::PipeBarrier<PIPE_ALL>();
...
#define GET_TILING_DATA(tiling_data, tiling_arg)                                                                       \
    AtbOps::CastTilingData tiling_data;                                                                                \
