...
#include "mixops/elewise/dynamic_quant/dynamic_quant_tiling/tiling_data.h"
...
inline __aicore__ void InitTilingData(const __gm__ uint8_t *p_tilingdata,
    AtbOps::DynamicQuantTilingData *tilingdata)
{
    ...
    CopyGmTilingToUb(tilingdata_in_ub, p_tilingdata, sizeof(AtbOps::DynamicQuantTilingData), &pipe);
...
#define GET_TILING_DATA(tiling_data, tiling_arg)                                                        \
    AtbOps::DynamicQuantTilingData tiling_data;                                                      \
