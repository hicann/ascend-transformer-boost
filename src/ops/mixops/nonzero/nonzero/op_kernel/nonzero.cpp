...
#include "mixops/nonzero/nonzero/tiling/tiling_data.h"
...
inline __aicore__ void InitTilingData(const __gm__ uint8_t *p_tilingdata, AtbOps::NonzeroTilingData *tilingdata)
{
    ...
    CopyGmTilingToUb(tilingdata_in_ub, p_tilingdata, sizeof(AtbOps::NonzeroTilingData), &pipe);
...
#define GET_TILING_DATA(tiling_data, tiling_arg)    \
    AtbOps::NonzeroTilingData tiling_data;      \
