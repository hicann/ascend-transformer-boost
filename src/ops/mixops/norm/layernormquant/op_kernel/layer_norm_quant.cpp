...
#include "mixops/norm/layernormquant/tiling/tiling_data.h"
...
public:
    ...
    __aicore__ inline void Init(__gm__ uint8_t *x, __gm__ uint8_t *gamma, __gm__ uint8_t *beta, __gm__ uint8_t *scale,
                                __gm__ uint8_t *offset, __gm__ uint8_t *z, AtbOps::LayerNormQuantTilingData tilingData)
    {
        half_num = 2;
...
inline __aicore__ void InitTilingData(const __gm__ uint8_t *p_tilingdata, AtbOps::LayerNormQuantTilingData *tilingdata)
{
    ...
    CopyGmTilingToUb(tilingdata_in_ub, p_tilingdata, sizeof(AtbOps::LayerNormQuantTilingData), &pipe);
...
#define GET_TILING_DATA(tilingArg, tilingData)                                                                         \
    AtbOps::LayerNormQuantTilingData tilingData;                                                                       \
