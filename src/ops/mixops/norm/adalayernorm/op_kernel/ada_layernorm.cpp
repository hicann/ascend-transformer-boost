...
#include "mixops/norm/adalayernorm/tiling/tiling_data.h"
...
public:
    ...
    __aicore__ inline void Init(__gm__ uint8_t *x, __gm__ uint8_t *gamma, __gm__ uint8_t *beta,
                                __gm__ uint8_t *z, AtbOps::AdaLayerNormTilingData &tilingData, AscendC::TPipe* pipe)
    {
...
inline __aicore__ void InitTilingData(const __gm__ uint8_t *p_tilingdata, AtbOps::AdaLayerNormTilingData *tilingdata)
{
    ...
    CopyGmTilingToUb(tilingdata_in_ub, p_tilingdata, sizeof(AtbOps::AdaLayerNormTilingData), &pipe);
...
#define GET_TILING_DATA(tilingArg, tilingData) \
    AtbOps::AdaLayerNormTilingData tilingData; \
