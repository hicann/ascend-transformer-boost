...
#include "mixops/norm/gatherprermsnorm/tiling/gather_pre_rms_norm_tiling_data.h"
...
public:
    __aicore__ inline GatherPreRmsnormSmallIndices(AscendC::TPipe *pipe, __gm__ uint8_t *x, __gm__ uint8_t *rIn,
        ...
        AtbOps::GatherPreRmsNormTilingData &tilingData)
    {
        ...
        pipe->InitBuffer(brcbBuf_, AtbOps::BRCB_BYTE);
    }
...
public:
    ...
    __aicore__ inline void Launch()
    {
        ...
        uint32_t tailIndicesNumAlign = (tailIndicesNum + AtbOps::INT32_ALIGN_NUM - 1) /
                                        AtbOps::INT32_ALIGN_NUM * AtbOps::INT32_ALIGN_NUM;
...
inline __aicore__ void InitTilingData(const __gm__ uint8_t *pTilingdata, AtbOps::GatherPreRmsNormTilingData *tilingdata)
{
    ...
    CopyGmTilingToUb(tilingdataInUb, pTilingdata, sizeof(AtbOps::GatherPreRmsNormTilingData), &pipe);
