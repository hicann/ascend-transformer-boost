 ...
 */
#ifndef ATBOPS_POST_LAYER_NORM_BASE
#define ATBOPS_POST_LAYER_NORM_BASE

#include "kernel_operator.h"
#include "mixops/utils/common/kernel/kernel_utils.h"
#include "mixops/norm/postlayernorm/tiling/tiling_data.h"
...
public:
    ...
    __aicore__ inline void InitBase(__gm__ uint8_t *x, __gm__ uint8_t *y, __gm__ uint8_t *gamma,
                                    __gm__ uint8_t *beta, AtbOps::PostLayerNormTilingData &tilingData)
    {
...
inline __aicore__ void InitTilingData(const __gm__ uint8_t *p_tilingdata, AtbOps::PostLayerNormTilingData *tilingdata)
{
    ...
    CopyGmTilingToUb(tilingdata_in_ub, p_tilingdata, sizeof(AtbOps::PostLayerNormTilingData), &pipe);
...
#define GET_TILING_DATA(tiling_data, tiling_arg) \
    AtbOps::PostLayerNormTilingData tiling_data; \
