...
#include "mixops/norm/coherelayernorm/tiling/tiling_data.h"
...
public:
    __aicore__ inline CohereLayerNorm(__gm__ uint8_t *x, __gm__ uint8_t *gamma, __gm__ uint8_t *y,
                                      const AtbOps::CohereLayerNormTilingData &tilingDataPtr)
...
inline __aicore__ void InitTilingData(const __gm__ uint8_t *p_tilingdata, AtbOps::CohereLayerNormTilingData *tilingdata)
{
    ...
    CopyGmTilingToUb(tilingdata_in_ub, p_tilingdata, sizeof(AtbOps::CohereLayerNormTilingData), &pipe);
...
#define GET_TILING_DATA(tilingArg, tilingData)                                                                         \
    AtbOps::CohereLayerNormTilingData tilingData;                                                                      \
