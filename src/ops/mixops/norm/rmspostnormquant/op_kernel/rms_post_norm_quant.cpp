...
public:
    __aicore__ inline RmsPostNormQuant(AscendC::TPipe *pipe, __gm__ uint8_t *x, __gm__ uint8_t *r, __gm__ uint8_t *g,
                                      ...
                                      __gm__ uint8_t *res, AtbOps::RmsNormQuantCommonTilingData &tilingData)
    {
...
inline __aicore__ void InitTilingData(const __gm__ uint8_t *pTilingdata,
                                      AtbOps::RmsNormQuantCommonTilingData *tilingdata)
{
    ...
    CopyGmTilingToUb(tilingdataInUb, pTilingdata, sizeof(AtbOps::RmsNormQuantCommonTilingData), &pipe);
