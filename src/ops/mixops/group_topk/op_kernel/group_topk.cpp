...
#include "mixops/group_topk/tiling/tiling_data.h"
...
public:
    ...
    __aicore__ explicit GroupTopk(GM_ADDR topKInput, GM_ADDR idxArr, AscendC::TPipe &pipe,
                                  const AtbOps::GroupTopkTilingData &tilingData)
...
__aicore__ inline void InitTilingData(const __gm__ uint8_t *tiling, AtbOps::GroupTopkTilingData *tilingData)
{
...
#define GET_TILING_DATA(tiling, tilingData)                                                                            \
    AtbOps::GroupTopkTilingData tilingData;                                                                            \
    InitTilingData(tiling, &(tilingData))

template <typename T, GroupMultiFlag GROUP_FLAG>
__aicore__ inline void group_topk_impl(GM_ADDR topKInput, GM_ADDR idxArr, AtbOps::GroupTopkTilingData &tilingData)
{
    AscendC::TPipe pipe;
