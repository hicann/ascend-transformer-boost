...
#include "mixops/toppsample/tiling/tiling_data.h"
...
public:
                                ...
                                AtbOps::ToppsampleTilingData &tiling_data)
    {
        ...
        yGm_.SetGlobalBuffer((__gm__ T *)y); // batch,num_samples
...
extern "C" __global__ __aicore__ void toppsample(GM_ADDR x, GM_ADDR y, GM_ADDR z, GM_ADDR workspace, GM_ADDR tiling)
{
