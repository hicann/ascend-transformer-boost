...
static constexpr uint32_t TILING_FP32 = 21;
static constexpr uint32_t TILING_FP16 = 20;
namespace AtbOps {


Status TilingKeyChose(const LaunchParam &launchParam, KernelInfo &kernelInfo, RopeQConcatTilingData *tilingDataPtr)
{
