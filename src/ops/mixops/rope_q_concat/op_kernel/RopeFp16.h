...
public:
        ...
        : RopeBase<QK_DTYPE, COS_DTYPE, IF_COS_BROADCAST>(tilingData, pipe)
    {
        ...
        uint32_t dataNum = this->tilingData_->headDim * this->tilingData_->maxNPerLoopForUb;
        uint32_t dataSizeFp16 = dataNum * sizeof(QK_DTYPE);
        uint32_t dataSizeFp32 = dataNum * sizeof(float);
