...
private:
    ...
    int32_t CalSeqLenSum(const SVector<Tensor> &inTensors, const size_t seqLenTensorId);
    ...
    static aclnnStatus (*aclnnGetWorkspaceSizeFunc_)(
        ...
        int64_t keyAntiquantMode, int64_t valueAntiquantMode, const aclTensor *attentionOut,
        const aclTensor *softmaxLse, uint64_t *workspaceSize, aclOpExecutor **executor);
    static aclnnStatus (*aclnnExecuteFunc_)(void *workspace, uint64_t workspaceSize, aclOpExecutor *executor,
