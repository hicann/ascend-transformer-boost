 ...
 */
#ifndef ATB_ACLNN_OPERATION_H
#define ATB_ACLNN_OPERATION_H
#include <atb/operation_infra.h>
#include "operation_base.h"
#include "atb/core/aclnn/aclnn_operation_cache.h"

namespace atb {
/// An class that inherited from `atb::OperationBase` class. An `atb::OperationBase` class defines a series of
/// interfaces required for operation preparation and execution.
class AclNNOperation : public atb::OperationBase {
public:
    /// Class constructor.
    ///
