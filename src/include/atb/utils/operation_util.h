...
public:
    ...
    static int64_t GetTensorBatch(const TensorDesc &tensorDesc);
    static int64_t GetXTensorM(const TensorDesc &xTensorDesc, bool transposeA = false);
    ...
    static int64_t GetOutTensorM(const TensorDesc &outTensorDesc);
