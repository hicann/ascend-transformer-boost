...
#include "atb/core/kernel_graph.h"
...
private:
    ...
    bool PlanKernelGraph(uint8_t *kernelHostTilingBuffer, uint64_t maxTilingSize);
    bool PlanKernel(size_t nodeId, uint8_t *kernelHostTilingBuffer, uint64_t maxTilingSize);
