...
ElewiseOperation::ElewiseOperation(const infer::ElewiseParam &param) : OperationBase("ElewiseOperation"), param_(param)
{
    static std::map<infer::ElewiseParam::ElewiseType, std::string> opIniTable = {
        {infer::ElewiseParam::ElewiseType::ELEWISE_CAST, "ElewiseOperationCast"},
        {infer::ElewiseParam::ElewiseType::ELEWISE_MULS, "ElewiseOperationMuls"},
        ...
        {infer::ElewiseParam::ElewiseType::ELEWISE_ADD, "ElewiseOperationAdd"},
        {infer::ElewiseParam::ElewiseType::ELEWISE_SUB, "ElewiseOperationSub"},
        {infer::ElewiseParam::ElewiseType::ELEWISE_MUL, "ElewiseOperationMul"},
                                                    ...
                                                    SVector<TensorDesc> &outTensorDescs) const
{
    ...
    if (dtype == ACL_FLOAT16) {
        ...
        ATB_LOG(WARN) << "ElewiseOperation InferShapeImplDynamicQuant: inTensor only support FP16 now.";
        return ERROR_INVALID_PARAM;
    }
}
