...
private:
    ...
    Status SetupCheckImplBypassBNSD310P(const SVector<Tensor> &inTensors, const SVector<Tensor> &outTensors) const;
    Status SetupCheckImplBypassBNSD910B(const SVector<Tensor> &inTensors, const SVector<Tensor> &outTensors) const;

    Status InferQKVQuantDimCheck(const SVector<TensorDesc> &inTensorDescs) const;

    Status SetupDimNumCheckBypassBNSD310P(const SVector<Tensor> &inTensors) const;
    Status SetupDimNumCheckBypassBNSD910B(const SVector<Tensor> &inTensors) const;
