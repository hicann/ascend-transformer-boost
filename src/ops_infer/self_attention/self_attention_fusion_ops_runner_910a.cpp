...
Status SelfAttentionFusionOpsRunner910A::SetupKernelGraph(const OpsTensorPack &opsTensorPack)
{
    ...
    kCacheParam.type = param_.batchRunStatusEnable ? AtbOps::OpParam::KVCache::KVCACHE_DYNAMIC_BATCH :
                                                     AtbOps::OpParam::KVCache::KVCACHE_NZ;
    kCacheParam.qSeqLen = {};
    kCacheParam.kvSeqLen = {};
    kCacheParam.batchRunStatus = {};
    kCacheNode.opDesc = {0, "KVCacheOperation", kCacheParam};
    kCacheNode.inTensors = {&transdataKResultTensor, &layerId, &cacheK, &tokenOffset, &seqLen};
    ...
    vCacheNode.inTensors = {&transdataVResultTensor, &layerId, &cacheV, &tokenOffset, &seqLen};
