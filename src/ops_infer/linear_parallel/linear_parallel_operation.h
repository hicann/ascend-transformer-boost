...
private:
    ...
    Status InferShapeCheckMatmulAllToAll(const SVector<TensorDesc> &inTensorDescss) const;
    ...
    Status SetupCheckMatmulAllToAll(const SVector<TensorDesc> &inTensorDescs,
                                    const TensorDesc &outTensorDesc) const;
