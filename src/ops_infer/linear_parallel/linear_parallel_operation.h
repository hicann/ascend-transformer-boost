...
private:
    ...
    Status InferShapeAllToAllvcAllGatherGmm(const SVector<TensorDesc> &inTensorDescs,
                                            SVector<TensorDesc> &outTensorDescs) const;
    Status InferShapeMatmulAllToAll(const SVector<TensorDesc> &inTensorDescs,
                                    SVector<TensorDesc> &outTensorDescs) const;
    Status InferShapeAllToAllMatmul(const SVector<TensorDesc> &inTensorDescs,
                                    SVector<TensorDesc> &outTensorDescs) const;
    ...
    Status InferShapeCheckMatmulAllToAll(const SVector<TensorDesc> &inTensorDescs) const;
    Status InferShapeCheckAllToAllMatmul(const SVector<TensorDesc> &inTensorDescs) const;
    ...
    Status SetupCheckMatmulAllToAll(const SVector<TensorDesc> &inTensorDescs, const TensorDesc &outTensorDesc) const;
    Status SetupCheckALLToAllMatmul(const SVector<TensorDesc> &inTensorDescs, const TensorDesc &outTensorDesc) const;
