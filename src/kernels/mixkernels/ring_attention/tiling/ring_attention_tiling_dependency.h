...
*/
#ifndef RING_ATTENTION_TILING_DEPENDENCY_H
#define RING_ATTENTION_TILING_DEPENDENCY_H
...
constexpr int32_t TILING_HEAD_SIZE = 39;
...
using RingAttentionInfo = struct RingAttentionTilingParams {
    OpParam::RingAttention::Type type;
    int32_t batchSize{0};
    ...
    OpParam::RingAttention::ScaleType scaleType = OpParam::RingAttention::SCALE_TOR;
    FaTensor tensors;
};
...
Status FillTilingParam(const RingAttentionInfo &mmInfo, const uint32_t &torUptr,
...
void FillTilingHead(const RingAttentionInfo &mmInfo, const uint32_t &torUptr,
    AddrOffsets &addrOffsets, int32_t kvRealHeads, uint32_t *tilingParam);
void DecoderSplitCore(const RingAttentionInfo &mmInfo, AddrOffsets &addrOffsets,
    int32_t kvRealHeads, uint32_t *tilingParam);
...
#endif
// RING_ATTENTION_TILING_DEPENDENCY_H
