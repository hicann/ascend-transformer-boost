 ...
 */
#ifndef ATBOPS_PARAMS_RING_ATTENTION_H
#define ATBOPS_PARAMS_RING_ATTENTION_H
...
struct RingAttention {
    ...
    bool operator==(const RingAttention &other) const
    {
...
#endif // ATBOPS_PARAMS_RING_ATTENTION_H