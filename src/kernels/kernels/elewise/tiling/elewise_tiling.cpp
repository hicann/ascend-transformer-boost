                     ...
                     const BinHandle &binHandle)
{
    ...
    if (tensorDesc0.dtype == TENSOR_DTYPE_FLOAT16) {
        ...
        auto runner = AsdOpsGeRt::TbeTilingRunner()
            ...
            .SetKernelName(kernelName)
            .AddInput(tensorDesc0.dtype, tensorDesc0.format, tensorDesc0.dims)
            .AddConstInput(TENSOR_DTYPE_BF16, TENSOR_FORMAT_ND, paramShape, ScalePointer.data(), sizeof(bf16_t))
            .AddConstInput(TENSOR_DTYPE_BF16, TENSOR_FORMAT_ND, paramShape, OffsetPointer.data(), sizeof(bf16_t))
            .AddOutput(tensorDescOut0.dtype, tensorDescOut0.format, tensorDescOut0.dims)
            .AddAttrBool(false)
            .AddAttrStr("round")
            .AddAttrInt(dstType)
