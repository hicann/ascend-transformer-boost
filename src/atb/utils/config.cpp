...
Config::Config()
{
    ...
    isOpsRunnerSetupCacheEnable_ = IsEnable("ATB_OPSRUNNER_SETUP_CACHE_ENABLE");
    isLaunchKernelWithTiling_ = IsEnable("ATB_LAUNCH_KERNEL_WITH_TILING");
    ...
    isworkspaceMemAllocGlobal_ = IsEnable("ATB_WORKSPACE_MEM_ALLOC_GLOBAL", true);
    isMatmulShuffleKEnable_ = IsEnable("ATB_MATMUL_SHUFFLE_K_ENABLE");
...
void Config::InitKernelCache()
{
    ...
    kernelCacheType_ = envStr != nullptr ? static_cast<uint32_t>(strtol(envStr, nullptr, DECIMAL)) : 0;
