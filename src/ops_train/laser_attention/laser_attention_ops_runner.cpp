...
Status LaserAttentionOpsRunner::SetupKernelGraph(const OpsTensorPack &opsTensorPack)
{
    ...
    Mki::Tensor &attentionOutTensorFloat = kernelGraph_.internalTensors.at(0);

    kernelGraph_.nodes.resize(SIZE_2);
    KernelGraphNode &laserAttentionNode = kernelGraph_.nodes.at(0);
    KernelGraphNode &elewiseCastAttentionOutNode = kernelGraph_.nodes.at(1);
    ...
    laserAttentionNode.outTensors = {&softmaxMaxTensor, &softmaxSumTensor, &attentionOutTensorFloat};

    AsdOps::OpParam::Elewise elewiseCastAttentionOutParam;
    elewiseCastAttentionOutParam.elewiseType = AsdOps::OpParam::Elewise::ElewiseType::ELEWISE_CAST;
    elewiseCastAttentionOutParam.outTensorType = Mki::TENSOR_DTYPE_BF16;
    elewiseCastAttentionOutNode.opDesc = {0, "ElewiseOperation", elewiseCastAttentionOutParam};
    elewiseCastAttentionOutNode.inTensors = {&attentionOutTensorFloat};
    elewiseCastAttentionOutNode.outTensors = {&attentionOutTensor};
