# AllReduceOperation C++ Demo

## Introduction

This directory contains the C++ call sample of AllReduceOperation.
...
all_reduce_demo.cpp: This demo can run only on Atlas A2/A3 products.
