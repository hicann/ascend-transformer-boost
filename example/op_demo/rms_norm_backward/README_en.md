# RmsNormBackwardOperation C++ Demo

## Introduction

This directory contains the C++ call sample of RmsNormBackwardOperation.
...
- Run the demo.
    ...
    **Note:**
    ...
    - RmsNormBackwardOperation is a backward operator. Therefore, the training library `atb_train` needs to be linked additionally. By default, the training library has been linked.
...
rms_norm_backward_demo.cpp supports only Atlas A2/A3 products.
