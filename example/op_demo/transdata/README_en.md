# TransdataOperation C++ Demo

## Introduction

This directory contains the C++ call sample of TransdataOperation.
...
The data generated in the example does not represent the actual outputs. For details about data generation, see the use case directory under the root directory:
