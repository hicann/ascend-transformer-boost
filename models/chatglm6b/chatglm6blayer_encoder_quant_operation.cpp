 ...
 */
#include "chatglm6blayer_encoder_quant_operation.h"
...
enum Chatglm6BLayerEncoderQuantTensorId {
    IN_HIDDENSTATES = 0,
    IN_QKVMIXDWEIGHT,
    IN_QKVDEQSCALE,
    IN_QKVMIXDBIAS,
...
ChatGlm6BLayerEncoderQuantOperation::ChatGlm6BLayerEncoderQuantOperation(const ChatGlm6BLayerQuantParam &param)
    : GraphOperation("ChatGlm6BLayerEncoderQuantOperation"), param_(param)
{
...
ChatGlm6BLayerEncoderQuantOperation::~ChatGlm6BLayerEncoderQuantOperation() {}

uint64_t ChatGlm6BLayerEncoderQuantOperation::GetInTensorCount() const { return IN_TENSOR_COUNT; }

uint64_t ChatGlm6BLayerEncoderQuantOperation::GetOutTensorCount() const { return OUT_TENSOR_COUNT; }

AsdOps::Status
ChatGlm6BLayerEncoderQuantOperation::InferShapeImpl(const AsdOps::SVector<AsdOps::Tensor> &inTensors,
                                                    AsdOps::SVector<AsdOps::TensorDesc> &outTensorDescs) const
{
    ...
    const size_t tensorId3 = 3;
    outTensorDescs.at(tensorId3) = inTensors.at(0).desc;
