 ...
 */
#include "chatglm6blayer_encoder_first_quant_operation.h"
...
enum Chatglm6BLayerEncoderFirstQuantTensorId {
    IN_HIDDENSTATES = 0,
    IN_QKVMIXDWEIGHT,
    IN_QKVDEQSCALE,
    IN_QKVMIXDBIAS,
...
ChatGlm6BLayerEncoderFirstQuantOperation::ChatGlm6BLayerEncoderFirstQuantOperation(
    const ChatGlm6BLayerQuantParam &param)
    : GraphOperation("ChatGlm6BLayerEncoderFirstQuantOperation"), param_(param)
{
...
uint64_t ChatGlm6BLayerEncoderFirstQuantOperation::GetInTensorCount() const { return IN_TENSOR_COUNT; }

uint64_t ChatGlm6BLayerEncoderFirstQuantOperation::GetOutTensorCount() const { return OUT_TENSOR_COUNT; }

AsdOps::Status
ChatGlm6BLayerEncoderFirstQuantOperation::InferShapeImpl(const AsdOps::SVector<AsdOps::Tensor> &inTensors,
