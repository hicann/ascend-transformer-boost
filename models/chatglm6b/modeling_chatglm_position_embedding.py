...
class SelfAttention(torch.nn.Module):
    def __init__(self, hidden_size, num_attention_heads,
        ...
        self.acl_position_embedding_operation.set_param(json.dumps({"headNum": 32}))
    ...
    def forward(
        ...
        acl_position_embedding_input = mixed_raw_layer
        acl_q_emb = None
        acl_k_emb = None
        acl_v_emb = None
        ...
        if self.position_encoding_2d:
            ...
            acl_q_emb, acl_k_emb, acl_v = self.acl_position_embedding_operation.execute([acl_position_embedding_input, position_ids, cos, sin])
        ...
        if torch.allclose(acl_q_emb, query_layer, rtol=0.02, atol=0.02) or \
            torch.allclose(acl_v, value_layer, rtol=0.02, atol=0.02) or \
           torch.allclose(acl_k_emb, key_layer, rtol=0.02, atol=0.02):
            print("equal")
        else:
            print("not euqal")
            exit()
