 ...
 */
#include "chatglm6blayer_encoder_without_fusion_operation.h"
...
enum Chatglm6BLayerEncoderWithoutFusionTensorId {
    IN_HIDDENSTATES = 0,
    IN_NORMWEIGHT,
    IN_NORMBIAS,
    IN_QKVMIXDWEIGHT,
...
ChatGlm6BLayerEncoderWithoutFusionOperation::ChatGlm6BLayerEncoderWithoutFusionOperation(
    const ChatGlm6BLayerParam &param)
    : GraphOperation("ChatGlm6BLayerEncoderWithoutFusionOperation"), param_(param)
{
...
uint64_t ChatGlm6BLayerEncoderWithoutFusionOperation::GetInTensorCount() const { return IN_TENSOR_COUNT; }

uint64_t ChatGlm6BLayerEncoderWithoutFusionOperation::GetOutTensorCount() const { return OUT_TENSOR_COUNT; }

AsdOps::Status
ChatGlm6BLayerEncoderWithoutFusionOperation::InferShapeImpl(const AsdOps::SVector<AsdOps::Tensor> &inTensors,
