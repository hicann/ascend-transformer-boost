...
class ChatGLMModel(ChatGLMPreTrainedModel):
    ...
    def __init__(self, config: ChatGLMConfig):
        ...
        self.acl_operation = torch.classes.ChatGlm6BModelRopeTorch.ChatGlm6BModelRopeTorch()
    ...
    def forward(
        ...
        if past_key_values[0] is not None:
            ...
            acl_model_out = self.acl_operation.execute(hidden_states, position_ids, cosTable, sinTable, attention_mask, past_keys, past_values, seq_len)
