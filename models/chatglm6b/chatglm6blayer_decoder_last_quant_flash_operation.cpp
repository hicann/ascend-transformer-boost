 ...
 */
#include "chatglm6blayer_decoder_last_quant_flash_operation.h"
...
enum Chatglm6BLayerDecoderLastQuantFlashTensorId {
    IN_HIDDENSTATES = 0,
    IN_QKVMIXDWEIGHT,
    IN_QKVDEQSCALE,
    IN_QKVMIXDBIAS,
...
ChatGlm6BLayerDecoderLastQuantFlashOperation::ChatGlm6BLayerDecoderLastQuantFlashOperation(
    const ChatGlm6BLayerQuantFlashParam &param)
    : GraphOperation("ChatGlm6BLayerDecoderLastQuantFlashOperation"), param_(param)
{
...
uint64_t ChatGlm6BLayerDecoderLastQuantFlashOperation::GetInTensorCount() const { return IN_TENSOR_COUNT; }

uint64_t ChatGlm6BLayerDecoderLastQuantFlashOperation::GetOutTensorCount() const { return OUT_TENSOR_COUNT; }

AsdOps::Status
ChatGlm6BLayerDecoderLastQuantFlashOperation::InferShapeImpl(const AsdOps::SVector<AsdOps::Tensor> &inTensors,
