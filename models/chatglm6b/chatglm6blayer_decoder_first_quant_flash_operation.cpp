 ...
 */
#include "chatglm6blayer_decoder_first_quant_flash_operation.h"
...
enum Chatglm6BLayerFirstQuantFlashTensorId {
    IN_HIDDENSTATES = 0,
    IN_QKVMIXDWEIGHT,
    IN_QKVDEQSCALE,
    IN_QKVMIXDBIAS,
...
ChatGlm6BLayerDecoderFirstQuantFlashOperation::ChatGlm6BLayerDecoderFirstQuantFlashOperation(
    const ChatGlm6BLayerQuantFlashParam &param)
    : GraphOperation("ChatGlm6BLayerDecoderFirstQuantFlashOperation"), param_(param)
{
...
uint64_t ChatGlm6BLayerDecoderFirstQuantFlashOperation::GetInTensorCount() const { return IN_TENSOR_COUNT; }

uint64_t ChatGlm6BLayerDecoderFirstQuantFlashOperation::GetOutTensorCount() const { return OUT_TENSOR_COUNT; }

AsdOps::Status
ChatGlm6BLayerDecoderFirstQuantFlashOperation::InferShapeImpl(const AsdOps::SVector<AsdOps::Tensor> &inTensors,
