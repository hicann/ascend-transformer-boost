 ...
 */
#include "baichuan2_7b_layer_encoder_parallel_operation.h"
...
enum BaiChuan27BLayerEncoderParallelTensorId {
    IN_HIDDENSTATES = 0,
    IN_NORMWEIGHT,
...
BaiChuan27BLayerEncoderParallelOperation::BaiChuan27BLayerEncoderParallelOperation(
    const BaiChuan27BLayerParallelParam &param)
    : GraphOperation("BaiChuan27BLayerEncoderParallelOperation"), param_(param)
{
...
uint64_t BaiChuan27BLayerEncoderParallelOperation::GetInTensorCount() const { return IN_TENSOR_COUNT; }

uint64_t BaiChuan27BLayerEncoderParallelOperation::GetOutTensorCount() const { return OUT_TENSOR_COUNT; }

AsdOps::Status
BaiChuan27BLayerEncoderParallelOperation::InferShapeImpl(const AsdOps::SVector<AsdOps::Tensor> &inTensors,
