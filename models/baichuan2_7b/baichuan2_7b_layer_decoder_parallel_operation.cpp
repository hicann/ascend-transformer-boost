 ...
 */
#include "baichuan2_7b_layer_decoder_parallel_operation.h"
...
enum BaiChuan27BLayerParallelTensorId {
    IN_HIDDENSTATES = 0,
    IN_NORMWEIGHT,
...
BaiChuan27BLayerDecoderParallelOperation::BaiChuan27BLayerDecoderParallelOperation(const BaiChuan27BLayerParallelParam &param)
    : GraphOperation("BaiChuan27BLayerDecoderParallelOperation"), param_(param)
{
...
BaiChuan27BLayerDecoderParallelOperation::~BaiChuan27BLayerDecoderParallelOperation() {}

uint64_t BaiChuan27BLayerDecoderParallelOperation::GetInTensorCount() const { return IN_TENSOR_COUNT; }

uint64_t BaiChuan27BLayerDecoderParallelOperation::GetOutTensorCount() const { return OUT_TENSOR_COUNT; }

AsdOps::Status BaiChuan27BLayerDecoderParallelOperation::InferShapeImpl(const AsdOps::SVector<AsdOps::Tensor> &inTensors,
