 ...
 */
#include "baichuan13b_layer_decoder_operation.h"
...
BaiChuan13BLayerDecoderOperation::BaiChuan13BLayerDecoderOperation(const BaiChuan13BLayerParam &param)
    : GraphOperation("BaiChuan13BLayerDecoderOperation"), param_(param)
{
...
BaiChuan13BLayerDecoderOperation::~BaiChuan13BLayerDecoderOperation() {}

uint64_t BaiChuan13BLayerDecoderOperation::GetInTensorCount() const { return IN_TENSOR_COUNT; }

uint64_t BaiChuan13BLayerDecoderOperation::GetOutTensorCount() const { return OUT_TENSOR_COUNT; }

AsdOps::Status BaiChuan13BLayerDecoderOperation::InferShapeImpl(const AsdOps::SVector<AsdOps::Tensor> &inTensors,
