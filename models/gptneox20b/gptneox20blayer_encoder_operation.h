 ...
 */
#ifndef OPS_GPTNEOX20B_GPTNEOX20BLAYER_ENCODER_OPERATION_H
#define OPS_GPTNEOX20B_GPTNEOX20BLAYER_ENCODER_OPERATION_H
#include "acltransformer/graph_operation.h"
#include "gptneox20blayer_param.h"

namespace AclTransformer {
class GptNeox20BLayerEncoderOperation : public GraphOperation {
public:
    explicit GptNeox20BLayerEncoderOperation(const GptNeox20BLayerParam &param);
