 ...
 */
#ifndef OPS_CHATGML6B_CHATGLM6BLAYER_DECODER_OPERATION_H
#define OPS_CHATGML6B_CHATGLM6BLAYER_DECODER_OPERATION_H
#include "acltransformer/graph_operation.h"
#include "gptneox20blayer_param.h"

namespace AclTransformer {
class GptNeox20BLayerDecoderOperation : public GraphOperation {
public:
    explicit GptNeox20BLayerDecoderOperation(const GptNeox20BLayerParam &param);
