 ...
 */
#include "gptneox20blayer_decoder_operation.h"
...
enum GptNeox20BLayerDecoderTensorId {
    IN_HIDDENSTATES = 0,
    ...
    : GraphOperation("GptNeox20BLayerEncoderOperation"), param_(param)
{
    ...
    selfAttentionKvCacheNode.inTensorIds = {INTERMEDIATE_QUERYEMBED, INTERMEDIATE_KEYEMBED, INTERMEDIATE_VALUE,
                                            IN_ATTENTIONMASK, IN_PASTKEY, IN_PASTVALUE};
    selfAttentionKvCacheNode.outTensorIds = {INTERMEDIATE_SELFATTNOUT, OUT_PRESENTKEY, OUT_PRESENTVALUE};
...
GptNeox20BLayerDecoderOperation::~GptNeox20BLayerDecoderOperation() {}

uint64_t GptNeox20BLayerDecoderOperation::GetInTensorCount() const { return IN_TENSOR_COUNT; }

uint64_t GptNeox20BLayerDecoderOperation::GetOutTensorCount() const { return OUT_TENSOR_COUNT; }

AsdOps::Status GptNeox20BLayerDecoderOperation::InferShapeImpl(const AsdOps::SVector<AsdOps::Tensor> &inTensors,
