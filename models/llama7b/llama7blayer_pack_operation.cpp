...
LLaMA7BLayerPackOperation::LLaMA7BLayerPackOperation(const LLaMA7BLayerParam &param)
    : GraphOperation("LLaMA7BLayerPackOperation"), param_(param)
{
...
LLaMA7BLayerPackOperation::~LLaMA7BLayerPackOperation() {}

uint64_t LLaMA7BLayerPackOperation::GetInTensorCount() const { return IN_TENSOR_COUNT; }

uint64_t LLaMA7BLayerPackOperation::GetOutTensorCount() const { return OUT_TENSOR_COUNT; }

AsdOps::Status LLaMA7BLayerPackOperation::InferShapeImpl(const AsdOps::SVector<AsdOps::Tensor> &inTensors,
