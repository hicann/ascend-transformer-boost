 ...
 */
#ifndef OPS_LLAMA7B_LLAMA7BLAYER_OPERATION_H
#define OPS_LLAMA7B_LLAMA7BLAYER_OPERATION_H

#include "acltransformer/graph_operation.h"
#include "llama7blayer_param.h"

namespace AclTransformer {
class LLaMA7BLayerOperation : public GraphOperation {
public:
    explicit LLaMA7BLayerOperation(const LLaMA7BLayerParam &param);
