 ...
 */
#ifndef OPS_GLM130B_GLM130BLAYER_ENCODER_OPERATION_H
#define OPS_GLM130B_GLM130BLAYER_ENCODER_OPERATION_H
#include "acltransformer/graph_operation.h"
#include "glm130blayer_param.h"

namespace AclTransformer {
class Glm130BLayerEncoderOperation : public GraphOperation {
public:
    explicit Glm130BLayerEncoderOperation(const Glm130BLayerParam &param);
    ~Glm130BLayerEncoderOperation();
