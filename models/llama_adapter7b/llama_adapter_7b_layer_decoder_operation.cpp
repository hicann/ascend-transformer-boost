 ...
 */
#include "llama_adapter_7b_layer_decoder_operation.h"
...
enum LLaMAAdapter7BLayerTensorId {
    IN_HIDDENSTATES = 0,
    IN_NORMWEIGHT,
    IN_QWEIGHT,
    IN_QBIAS,
...
LLaMAAdapter7BLayerOperation::LLaMAAdapter7BLayerOperation(const LLaMAAdapter7BLayerParam &param)
    : GraphOperation("LLaMAAdapter7BLayerOperation"), param_(param)
{
...
LLaMAAdapter7BLayerOperation::~LLaMAAdapter7BLayerOperation() {}

uint64_t LLaMAAdapter7BLayerOperation::GetInTensorCount() const { return IN_TENSOR_COUNT; }

uint64_t LLaMAAdapter7BLayerOperation::GetOutTensorCount() const { return OUT_TENSOR_COUNT; }

AsdOps::Status LLaMAAdapter7BLayerOperation::InferShapeImpl(const AsdOps::SVector<AsdOps::Tensor> &inTensors,
