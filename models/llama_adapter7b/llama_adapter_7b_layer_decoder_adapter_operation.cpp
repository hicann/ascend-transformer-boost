 ...
 */
#include "llama_adapter_7b_layer_decoder_adapter_operation.h"
...
enum LLaMAAdapter7BLayerAdapterTensorId {
    IN_HIDDENSTATES = 0,
    IN_NORMWEIGHT,
    IN_QWEIGHT,
    IN_QBIAS,
...
LLaMAAdapter7BLayerAdapterOperation::LLaMAAdapter7BLayerAdapterOperation(const LLaMAAdapter7BLayerParam &param)
    : GraphOperation("LLaMAAdapter7BLayerAdapterOperation"), param_(param)
{
    ...
    selfAttentionDeNoAdapterNode.inTensorViewFuncs.at(5) = [=](const AsdOps::SVector<int64_t> &oldDims,
                                                           AsdOps::SVector<int64_t> &newDims) {
        newDims = {oldDims.at(0), oldDims.at(1), param_.headNum, oldDims.at(2) / param_.headNum};
    };
    selfAttentionDeNoAdapterNode.inTensorViewFuncs.at(6) = [=](const AsdOps::SVector<int64_t> &oldDims,
                                                           AsdOps::SVector<int64_t> &newDims) {
        newDims = {oldDims.at(0), oldDims.at(1), param_.headNum, oldDims.at(2) / param_.headNum};
    };
...
LLaMAAdapter7BLayerAdapterOperation::~LLaMAAdapter7BLayerAdapterOperation() {}

uint64_t LLaMAAdapter7BLayerAdapterOperation::GetInTensorCount() const { return IN_TENSOR_COUNT; }

uint64_t LLaMAAdapter7BLayerAdapterOperation::GetOutTensorCount() const { return OUT_TENSOR_COUNT; }

AsdOps::Status LLaMAAdapter7BLayerAdapterOperation::InferShapeImpl(const AsdOps::SVector<AsdOps::Tensor> &inTensors,
