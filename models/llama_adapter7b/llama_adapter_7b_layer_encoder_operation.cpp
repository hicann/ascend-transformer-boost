 ...
 */
#include "llama_adapter_7b_layer_encoder_operation.h"
...
enum LLaMAAdapter7BLayerEncoderTensorId {
    IN_HIDDENSTATES = 0,
    IN_NORMWEIGHT,
    IN_QWEIGHT,
    IN_QBIAS,
...
LLaMAAdapter7BLayerEncoderOperation::LLaMAAdapter7BLayerEncoderOperation(const LLaMAAdapter7BLayerParam &param)
    : GraphOperation("LLaMAAdapter7BLayerEncoderOperation"), param_(param)
{
    ...
    selfAttentionCrossParam.model = param_.model;//llama_adapter
...
LLaMAAdapter7BLayerEncoderOperation::~LLaMAAdapter7BLayerEncoderOperation() {}

uint64_t LLaMAAdapter7BLayerEncoderOperation::GetInTensorCount() const { return IN_TENSOR_COUNT; }

uint64_t LLaMAAdapter7BLayerEncoderOperation::GetOutTensorCount() const { return OUT_TENSOR_COUNT; }

AsdOps::Status LLaMAAdapter7BLayerEncoderOperation::InferShapeImpl(const AsdOps::SVector<AsdOps::Tensor> &inTensors,
