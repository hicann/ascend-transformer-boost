 ...
 */
#ifndef OPS_CHATGML2_6B_FUSION_DECODER_OPERATION_H
#define OPS_CHATGML2_6B_FUSION_DECODER_OPERATION_H
#include "acltransformer/graph_operation.h"
#include "chatglm2_6b_layer_param.h"

namespace AclTransformer {
class ChatGlm2FusionLayerDecoderOperation : public GraphOperation {
public:
    explicit ChatGlm2FusionLayerDecoderOperation(const ChatGlm2LayerParam &param);
