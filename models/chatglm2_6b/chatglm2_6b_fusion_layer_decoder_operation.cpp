 ...
 */
#include "chatglm2_6b_fusion_layer_decoder_operation.h"
...
enum Chatglm2FusionLayerDecoderTensorId {
    IN_HIDDENSTATES = 0,
    IN_NORMWEIGHT,
    IN_QKVMIXDWEIGHT,
    IN_QKVMIXDBIAS,
...
ChatGlm2FusionLayerDecoderOperation::ChatGlm2FusionLayerDecoderOperation(const ChatGlm2LayerParam &param)
    : GraphOperation("ChatGlm2FusionLayerDecoderOperation"), param_(param)
{
...
ChatGlm2FusionLayerDecoderOperation::~ChatGlm2FusionLayerDecoderOperation() {}

uint64_t ChatGlm2FusionLayerDecoderOperation::GetInTensorCount() const { return IN_TENSOR_COUNT; }

uint64_t ChatGlm2FusionLayerDecoderOperation::GetOutTensorCount() const { return OUT_TENSOR_COUNT; }

AsdOps::Status ChatGlm2FusionLayerDecoderOperation::InferShapeImpl(const AsdOps::SVector<AsdOps::Tensor> &inTensors,
