 ...
 */
#ifndef OPS_CHATGML2_6B_DECODER_OPERATION_H
#define OPS_CHATGML2_6B_DECODER_OPERATION_H
#include "acltransformer/graph_operation.h"
#include "chatglm2_6b_layer_param.h"

namespace AclTransformer {
class ChatGlm2LayerDecoderOperation : public GraphOperation {
public:
    explicit ChatGlm2LayerDecoderOperation(const ChatGlm2LayerParam &param);
    ~ChatGlm2LayerDecoderOperation();
