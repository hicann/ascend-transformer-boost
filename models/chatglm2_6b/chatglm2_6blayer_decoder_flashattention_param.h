 ...
 */
#ifndef OPS_CHATGML2_CHATGLM2LAYERDECODER_FLASHATTENTION_PARAM_H
#define OPS_CHATGML2_CHATGLM2LAYERDECODER_FLASHATTENTION_PARAM_H
#include <asdops/utils/svector/svector.h>

namespace AclTransformer {
struct ChatGlm2LayerDecoderFlashAttentionParam {
    float rmsNormEps = 0;
    int64_t headNum = 0;
    bool is2d = true;
