 ...
 */
#ifndef OPS_LLAMA13B_LLAMA13BLAYER_ENCODER_OPERATION_H
#define OPS_LLAMA13B_LLAMA13BLAYER_ENCODER_OPERATION_H

#include "acltransformer/graph_operation.h"
#include "llama13blayer_param_parallel.h"

namespace AclTransformer {
class LLaMA13BLayerEncoderOperation : public GraphOperation {
public:
    explicit LLaMA13BLayerEncoderOperation(const LLaMA13BLayerParam &param);
    ~LLaMA13BLayerEncoderOperation();
