 ...
 */
#include "llama13blayer_parallel_operation.h"
...
LLaMA13BLayerOperation::LLaMA13BLayerOperation(const LLaMA13BLayerParam &param)
    : GraphOperation("LLaMA13BLayerOperation"), param_(param)
{
    ...
    selfOutLinearParallelNode.operation.reset(
        new AclTransformer::LinearParallelOperation({false, param_.rank, param_.rankSize, 0, "", "RowParallel", "hccl"}));
    ...
    mlpLinearParallelNode.operation.reset(
        new AclTransformer::LinearParallelOperation({false, param_.rank, param_.rankSize, 0, "", "RowParallel", "hccl"}));
    mlpLinearParallelNode.inTensorIds = {INTERMIDATE_MLPOUT, IN_MLPDOWNWEIGHT, IN_SELFOUTLINEARBIAS};
...
LLaMA13BLayerOperation::~LLaMA13BLayerOperation() {}

uint64_t LLaMA13BLayerOperation::GetInTensorCount() const { return IN_TENSOR_COUNT; }

uint64_t LLaMA13BLayerOperation::GetOutTensorCount() const { return OUT_TENSOR_COUNT; }

AsdOps::Status LLaMA13BLayerOperation::InferShapeImpl(const AsdOps::SVector<AsdOps::Tensor> &inTensors,
