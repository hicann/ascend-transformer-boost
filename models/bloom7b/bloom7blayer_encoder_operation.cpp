 ...
 */
#include "bloom7blayer_encoder_operation.h"
...
Bloom7BLayerEncoderOperation::Bloom7BLayerEncoderOperation(const Bloom7BLayerParam &param)
    : GraphOperation("Bloom7BLayerEncoderOperation"), param_(param)
{
...
Bloom7BLayerEncoderOperation::~Bloom7BLayerEncoderOperation() {}

uint64_t Bloom7BLayerEncoderOperation::GetInTensorCount() const { return IN_TENSOR_COUNT; }

uint64_t Bloom7BLayerEncoderOperation::GetOutTensorCount() const { return OUT_TENSOR_COUNT; }

AsdOps::Status Bloom7BLayerEncoderOperation::InferShapeImpl(const AsdOps::SVector<AsdOps::Tensor> &inTensors,
