 ...
 */
#include "bloom7blayer_parallel_decoder_operation.h"
...
Bloom7BLayerParallelDecoderOperation::Bloom7BLayerParallelDecoderOperation(const Bloom7BLayerParallelParam &param)
    : GraphOperation("Bloom7BLayerParallelDecoderOperation"), param_(param)
{
    ...
    selfOutLinearNode.operation.reset(new AclTransformer::LinearParallelOperation(
        {false, param_.rank, param_.rankSize, 0, "yes", "RowParallel", "hccl", nullptr, true}));
...
Bloom7BLayerParallelDecoderOperation::~Bloom7BLayerParallelDecoderOperation() {}

uint64_t Bloom7BLayerParallelDecoderOperation::GetInTensorCount() const { return IN_TENSOR_COUNT; }

uint64_t Bloom7BLayerParallelDecoderOperation::GetOutTensorCount() const { return OUT_TENSOR_COUNT; }

AsdOps::Status Bloom7BLayerParallelDecoderOperation::InferShapeImpl(const AsdOps::SVector<AsdOps::Tensor> &inTensors,
