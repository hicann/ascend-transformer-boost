 ...
 */
#ifndef OPS_BLOOM7B_BLOOM7BLAYER_DECODER_OPERATION_H
#define OPS_BLOOM7B_BLOOM7BLAYER_DECODER_OPERATION_H
#include "acltransformer/graph_operation.h"
#include "bloom7blayer_param.h"

namespace AclTransformer {
class Bloom7BLayerDecoderOperation : public GraphOperation {
public:
    explicit Bloom7BLayerDecoderOperation(const Bloom7BLayerParam &param);
