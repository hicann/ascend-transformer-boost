 ...
 */
#include "baichuan2_13b_layer_decoder_operation.h"
...
enum BaiChuan213BLayerTensorId {
    IN_HIDDENSTATES = 0,
    IN_NORMWEIGHT,
...
BaiChuan213BLayerDecoderOperation::BaiChuan213BLayerDecoderOperation(const BaiChuan213BLayerParam &param)
    : GraphOperation("BaiChuan213BLayerDecoderOperation"), param_(param)
{
...
uint64_t BaiChuan213BLayerDecoderOperation::GetInTensorCount() const { return IN_TENSOR_COUNT; }

uint64_t BaiChuan213BLayerDecoderOperation::GetOutTensorCount() const { return OUT_TENSOR_COUNT; }

AsdOps::Status BaiChuan213BLayerDecoderOperation::InferShapeImpl(const AsdOps::SVector<AsdOps::Tensor> &inTensors,
