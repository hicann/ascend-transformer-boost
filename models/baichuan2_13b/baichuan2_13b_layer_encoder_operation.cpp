 ...
 */
#include "baichuan2_13b_layer_encoder_operation.h"
...
enum BaiChuan213BLayerEncoderTensorId {
    IN_HIDDENSTATES = 0,
    IN_NORMWEIGHT,
...
BaiChuan213BLayerEncoderOperation::BaiChuan213BLayerEncoderOperation(const BaiChuan213BLayerParam &param)
    : GraphOperation("BaiChuan213BLayerEncoderOperation"), param_(param)
{
    ...
    selfAttentionParam.model = "baichuan2_13b";
    selfAttentionNode.operation.reset(new AclTransformer::SelfAttentionOperation(selfAttentionParam));
    selfAttentionNode.inTensorIds = {INTERMIDATE_QKVMIXEDLINEAROUT, IN_ATTENTIONMASK};
...
BaiChuan213BLayerEncoderOperation::~BaiChuan213BLayerEncoderOperation() {}

uint64_t BaiChuan213BLayerEncoderOperation::GetInTensorCount() const { return IN_TENSOR_COUNT; }

uint64_t BaiChuan213BLayerEncoderOperation::GetOutTensorCount() const { return OUT_TENSOR_COUNT; }

AsdOps::Status
BaiChuan213BLayerEncoderOperation::InferShapeImpl(const AsdOps::SVector<AsdOps::Tensor> &inTensors,
