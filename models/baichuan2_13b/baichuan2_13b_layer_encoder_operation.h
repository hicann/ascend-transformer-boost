 ...
 */
#ifndef OPS_BAICHUAN2_13B_LAYER_ENCODER_OPERATION_H
#define OPS_BAICHUAN2_13B_LAYER_ENCODER_OPERATION_H

#include "acltransformer/graph_operation.h"
#include "baichuan2_13b_layer_param.h"

namespace AclTransformer {
class BaiChuan213BLayerEncoderOperation : public GraphOperation {
public:
    explicit BaiChuan213BLayerEncoderOperation(const BaiChuan213BLayerParam &param);
