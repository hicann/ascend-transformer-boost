 ...
 */
#ifndef CHATGLM6BMODEL_DECODER_WITHOUT_FUSION_TORCH_H
#define CHATGLM6BMODEL_DECODER_WITHOUT_FUSION_TORCH_H
#include <string>
#include <vector>
...
class ChatGlm6BModelDecoderWithoutFusionTorch : public torch::CustomClassHolder {
public:
    ChatGlm6BModelDecoderWithoutFusionTorch();
    ~ChatGlm6BModelDecoderWithoutFusionTorch();
    ...
    c10::intrusive_ptr<ChatGlm6BModelDecoderWithoutFusionTorch> clone() const
    {
        return c10::make_intrusive<ChatGlm6BModelDecoderWithoutFusionTorch>();
    }
