 ...
 */
#ifndef CHATGLM6BMODEL_ENCODER_QUANT_TORCH_H
#define CHATGLM6BMODEL_ENCODER_QUANT_TORCH_H
#include <string>
#include <vector>
...
class ChatGlm6BModelEncoderQuantTorch : public torch::CustomClassHolder {
public:
    ChatGlm6BModelEncoderQuantTorch();
    ~ChatGlm6BModelEncoderQuantTorch();
    ...
    c10::intrusive_ptr<ChatGlm6BModelEncoderQuantTorch> clone() const
    {
        return c10::make_intrusive<ChatGlm6BModelEncoderQuantTorch>();
    }
