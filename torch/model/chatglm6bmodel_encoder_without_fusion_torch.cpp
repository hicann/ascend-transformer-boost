 ...
 */
#include "chatglm6bmodel_encoder_without_fusion_torch.h"
...
#include "models/chatglm6b/chatglm6blayer_encoder_without_fusion_operation.h"

const size_t WEIGHT_COUNT_PER_LAYER = 12;

ChatGlm6BModelEncoderWithoutFusionTorch::ChatGlm6BModelEncoderWithoutFusionTorch()
{
    ASD_LOG(INFO)
        << "ChatGlm6BModelEncoderWithoutFusionTorch::ChatGlm6BModelEncoderWithoutFusionTorch, TASK_QUEUE_ENABLE:"
...
void ChatGlm6BModelEncoderWithoutFusionTorch::SetParam(std::string param)
{
    ...
    for (int i = 0; i < modelParam_.layerNum; ++i) {
        ...
        AclTransformer::Operation *op = new AclTransformer::ChatGlm6BLayerEncoderWithoutFusionOperation(opParam);
...
void ChatGlm6BModelEncoderWithoutFusionTorch::SetWeight(std::vector<torch::Tensor> weightTensors)
{
...
std::vector<torch::Tensor> ChatGlm6BModelEncoderWithoutFusionTorch::Execute(torch::Tensor hiddenStateTensor,
                                                                            ...
                                                                            torch::Tensor attentionMaskTensor)
{
    ...
    ExecuteOutImpl(hiddenStateTensor, positionIdTensor, cosTableTensor, sinTableTensor, attentionMaskTensor, outTensor,
                   presendKeyTensors, presentValueTensors, true);
...
void ChatGlm6BModelEncoderWithoutFusionTorch::ExecuteOut(torch::Tensor hiddenStateTensor,
                                                         torch::Tensor positionIdTensor, torch::Tensor cosTableTensor,
                                                         torch::Tensor sinTableTensor,
                                                         ...
                                                         std::vector<torch::Tensor> presentValueTensors)
{
    timer_.Reset();
    ExecuteOutImpl(hiddenStateTensor, positionIdTensor, cosTableTensor, sinTableTensor, attentionMaskTensor, outTensor,
                   presendKeyTensors, presentValueTensors, false);
}

void ChatGlm6BModelEncoderWithoutFusionTorch::ExecuteOutImpl(
...
void ChatGlm6BModelEncoderWithoutFusionTorch::BuildVariantPack(int layerId, std::vector<torch::Tensor> &atInTensors,
                                                               torch::Tensor &outTensor,
...
void ChatGlm6BModelEncoderWithoutFusionTorch::ExecuteSingleOperation(int layerId,
...
std::string ChatGlm6BModelEncoderWithoutFusionTorch::GetSaveTensorDir()
{
    const char *envStr = std::getenv("AIT_CMP_TASK_ID");
    std::string dir = "";
    if (envStr) {
        dir = std::string(envStr) + "/0_ChatGlm6BModelEncoderWithoutFusionTorch";
    } else {
        dir = std::to_string(executeCount_) + "/0_ChatGlm6BModelEncoderWithoutFusionTorch";
    }
    return AclTransformer::Config::GetSaveTensorDir() + "/" + dir;
}

TORCH_LIBRARY(ChatGlm6BModelEncoderWithoutFusionTorch, m)
{
    m.class_<ChatGlm6BModelEncoderWithoutFusionTorch>("ChatGlm6BModelEncoderWithoutFusionTorch")
        .def(torch::init<>())
        .def("set_param", &ChatGlm6BModelEncoderWithoutFusionTorch::SetParam)
        .def("set_weight", &ChatGlm6BModelEncoderWithoutFusionTorch::SetWeight)
        .def("execute", &ChatGlm6BModelEncoderWithoutFusionTorch::Execute)
        .def("execute_out", &ChatGlm6BModelEncoderWithoutFusionTorch::ExecuteOut);
}