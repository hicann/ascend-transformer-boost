 ...
 */
#ifndef GPTNEOX20BMODEL_ENCODER_TORCH_H
#define GPTNEOX20BMODEL_ENCODER_TORCH_H
#include <string>
#include <vector>
#include <torch/script.h>
#include <torch/custom_class.h>
#include <asdops/utils/time/timer.h>
#include "gptneox20bmodel_param.h"
#include "acltransformer/operation.h"
#include "acltransformer/plan.h"

class GptNeox20BModelEncoderTorch : public torch::CustomClassHolder {
public:
    GptNeox20BModelEncoderTorch();
    ~GptNeox20BModelEncoderTorch();
    ...
    c10::intrusive_ptr<GptNeox20BModelEncoderTorch> clone() const
    {
        return c10::make_intrusive<GptNeox20BModelEncoderTorch>();
    }
...
private:
    ...
    void ExecuteOutImpl(torch::Tensor &hiddenStateTensor, torch::Tensor &positionIdTensor,
                        torch::Tensor &cosTableTensor, torch::Tensor &sinTableTensor,
                        torch::Tensor &attentionMaskTensor, torch::Tensor &seqLen, torch::Tensor &outTensor,
                        std::vector<torch::Tensor> &presentKeyTensors, std::vector<torch::Tensor> &presentValueTensors,
                        bool newOut);
    // IN:hiddenStateTensor+12个权重+positionIdTensor+cosTable+sinTable+attentionMaskTensor+seqLen
...
private:
    GptNeox20BModelParam modelParam_;
