 ...
 */
#ifndef GPTNEOX20BMODEL_DECODER_TORCH_H
#define GPTNEOX20BMODEL_DECODER_TORCH_H
#include <string>
#include <vector>
...
class GptNeox20BModelDecoderTorch : public torch::CustomClassHolder {
public:
    GptNeox20BModelDecoderTorch();
    ~GptNeox20BModelDecoderTorch();
    ...
    c10::intrusive_ptr<GptNeox20BModelDecoderTorch> clone() const
    {
        return c10::make_intrusive<GptNeox20BModelDecoderTorch>();
    }
...
private:
    ...
    void ExecuteOutImpl(torch::Tensor &hiddenStateTensor, torch::Tensor &positionIdTensor,
                        ...
                        bool newOut);
    // IN:hiddenStateTensor+12个权重+positionIdTensor+cosTable+sinTable+attentionMaskTensor+seqLen+pastK+pastV
