 ...
 */
#ifndef LLAMA70B_DECODER_MODEL_H
#define LLAMA70B_DECODER_MODEL_H
#include "torch/model_v2/model.h"

namespace AclTransformer {
class Llama70BDecoderModel : public Model {
public:
    struct Param {
        float rmsNormEps = 0;
        int headNum = 0;
    ...
    Llama70BDecoderModel(const std::string &param);
    ~Llama70BDecoderModel();
