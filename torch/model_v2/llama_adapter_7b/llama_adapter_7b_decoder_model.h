...
*/
#ifndef LLAMA_ADAPTER_7B_MODELV2_DECODER_TORCH_H
#define LLAMA_ADAPTER_7B_MODELV2_DECODER_TORCH_H
#include "torch/model_v2/model.h"

namespace AclTransformer {
class LlamaAdapter7BDecoderModel : public Model {
public:
   struct Param {
       float rmsNormEps = 0;
       int headNum = 0;
   ...
   LlamaAdapter7BDecoderModel(const std::string &param);
