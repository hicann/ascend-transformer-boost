...
*/
#ifndef LLAMA_ADAPTER_7B_MODELV2_ENCODER_TORCH_H
#define LLAMA_ADAPTER_7B_MODELV2_ENCODER_TORCH_H
#include "torch/model_v2/model.h"

namespace AclTransformer {
class LlamaAdapter7BEncoderModel : public Model {
public:
   struct Param {
       float rmsNormEps = 0;
       int headNum = 0;
   ...
   LlamaAdapter7BEncoderModel(const std::string &param);
