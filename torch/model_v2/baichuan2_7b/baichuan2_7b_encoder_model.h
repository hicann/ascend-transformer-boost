 ...
 */
#ifndef BAICHUAN2_7B_MODELV2_ENCODER_TORCH_H
#define BAICHUAN2_7B_MODELV2_ENCODER_TORCH_H
#include "torch/model_v2/model.h"

namespace AclTransformer {
class BaiChuan27BEncoderModel : public Model {
public:
   struct Param {
       float rmsNormEps = 0;
       int headNum = 0;
    ...
    BaiChuan27BEncoderModel(const std::string &param);
    ~BaiChuan27BEncoderModel();
