 ...
 */
#ifndef BAICHUAN2_7B_MODELV2_FUSION_TORCH_H
#define BAICHUAN2_7B_MODELV2_FUSION_TORCH_H
#include "torch/model_v2/model.h"

namespace AclTransformer {
class BaiChuan27BFusionModel : public Model {
public:
   struct Param {
       float rmsNormEps = 0;
       int headNum = 0;
   ...
   BaiChuan27BFusionModel(const std::string &param);
