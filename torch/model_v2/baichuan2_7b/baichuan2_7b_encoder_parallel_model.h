...
*/
#ifndef BAICHUAN2_7B_ENCODER_PARALLEL_MODEL_H
#define BBAICHUAN2_7B_ENCODER_PARALLEL_MODEL_H
#include "torch/model_v2/model.h"

namespace AclTransformer {
class BaiChuan27BEncoderParallelModel : public Model {
public:
   struct Param {
       float rmsNormEps = 0;
       int headNum = 0;
   ...
   BaiChuan27BEncoderParallelModel(const std::string &param);
   ~BaiChuan27BEncoderParallelModel();
