...
BaiChuan27BDecoderParallelModel::BaiChuan27BDecoderParallelModel(const std::string &param): Model("BaiChuan27BDecoderParallelModel", param)
{
...
void BaiChuan27BDecoderParallelModel::BuildGraph()
{
   ...
   for (int layerId = 0; layerId < param_.layerNum; ++layerId) {
       ...
       BaiChuan27BLayerParallelParam opParam;
