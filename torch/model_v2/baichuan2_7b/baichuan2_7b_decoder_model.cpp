...
*/
#include "baichuan2_7b_decoder_model.h"
...
void BaiChuan27BDecoderModel::Param::FromString(const std::string &param)
{
...
BaiChuan27BDecoderModel::~BaiChuan27BDecoderModel(){}

uint64_t BaiChuan27BDecoderModel::GetInTensorCount() const { return graph_.inTensors.size(); }

uint64_t BaiChuan27BDecoderModel::GetOutTensorCount() const { return graph_.outTensors.size(); }

AsdOps::Status BaiChuan27BDecoderModel::InferShape(const std::vector<AsdOps::Tensor> &inTensors,
