...
*/
#ifndef BAICHUAN2_7B_DECODER_PARALLEL_MODEL_H
#define BAICHUAN2_7B_DECODER_PARALLEL_MODEL_H
#include "torch/model_v2/model.h"

namespace AclTransformer {
class BaiChuan27BDecoderParallelModel : public Model {
public:
   struct Param {
       float rmsNormEps = 0;
       int headNum = 0;
   ...
   BaiChuan27BDecoderParallelModel(const std::string &param);
   ~BaiChuan27BDecoderParallelModel();
