 ...
 */
#ifndef GPTNEOX20BMODELV2_ENCODER_TORCH_H
#define GPTNEOX20BMODELV2_ENCODER_TORCH_H
#include "torch/model_v2/model.h"

namespace AclTransformer {
class GptNeox20BEncoderModel : public Model {
public:
    struct Param {
    ...
    GptNeox20BEncoderModel(const std::string &param);
