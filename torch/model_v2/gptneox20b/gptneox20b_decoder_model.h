 ...
 */
#ifndef GPTNEOX20BMODELV2_DECODER_TORCH_H
#define GPTNEOX20BMODELV2_DECODER_TORCH_H
#include "torch/model_v2/model.h"

namespace AclTransformer {
class GptNeox20BDecoderModel : public Model {
public:
    struct Param {
    ...
    GptNeox20BDecoderModel(const std::string &param);
