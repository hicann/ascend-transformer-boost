 ...
 */
#ifndef GML130B_DECODER_MODEL_POST_OPERATION_H
#define GML130B_DECODER_MODEL_POST_OPERATION_H
#include "torch/model_v2/model.h"

namespace AclTransformer {
class Glm130BDecoderPostOperationModel : public Model {
public:
    struct Param {
        bool transKey = false;
        int layerNum = 0;
        ...
        AsdOps::SVector<int32_t> perm = {2, 1, 0, 3};
        void FromString(const std::string &param);
    };

    Glm130BDecoderPostOperationModel(const std::string &param);
    ~Glm130BDecoderPostOperationModel();
