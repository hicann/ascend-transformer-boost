 ...
 */
#ifndef GML130B_DECODER_FUSION_MODEL_H
#define GML130B_DECODER_FUSION_MODEL_H
#include "torch/model_v2/model.h"

namespace AclTransformer {
class Glm130BDecoderFusionModel : public Model {
public:
    struct Param {
        bool transKey = false;
        int layerNum = 0;
    ...
    Glm130BDecoderFusionModel(const std::string &param);
    ~Glm130BDecoderFusionModel();
