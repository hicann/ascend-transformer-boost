 ...
 */
#ifndef LLAMA7B_DECODER_WITHOUT_FUSION_MODEL_H
#define LLAMA7B_DECODER_WITHOUT_FUSION_MODEL_H
#include "torch/model_v2/model.h"

namespace AclTransformer {
class Llama7BDecoderWithoutFusionModel : public Model {
public:
    struct Param {
        double rmsNormEps = 0;
        int headNum = 0;
    ...
    Llama7BDecoderWithoutFusionModel(const std::string &param);
    ~Llama7BDecoderWithoutFusionModel();
