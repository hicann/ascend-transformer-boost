...
*/
#ifndef BAICHUAN1_7B_MODELV2_DECODER_TORCH_H
#define BAICHUAN1_7B_MODELV2_DECODER_TORCH_H
#include "torch/model_v2/model.h"

namespace AclTransformer {
class BaiChuan17BDecoderModel : public Model {
public:
   struct Param {
       float rmsNormEps = 0;
       int headNum = 0;
   ...
   BaiChuan17BDecoderModel(const std::string &param);
