 ...
 */
#ifndef CHATGML2_6B_QUANT_MIX_ENCODER_MODEL_H
#define CHATGML2_6B_QUANT_MIX_ENCODER_MODEL_H
#include "torch/model_v2/model.h"

namespace AclTransformer {
class ChatGlm2QuantMixEncoderModel : public Model {
public:
    struct Param {
        bool transKey = false;
        int layerNum = 0;
    ...
    ChatGlm2QuantMixEncoderModel(const std::string &param);
    ~ChatGlm2QuantMixEncoderModel();
