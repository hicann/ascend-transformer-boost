 ...
 */
#ifndef CHATGML2_6B_DECODER_MODEL_H
#define CHATGML2_6B_DECODER_MODEL_H
#include "torch/model_v2/model.h"

namespace AclTransformer {
class ChatGlm2DecoderModel : public Model {
public:
    struct Param {
        float rmsNormEps = 0;
        int headNum = 0;
    ...
    ChatGlm2DecoderModel(const std::string &param);
    ~ChatGlm2DecoderModel();
