 ...
 */
#ifndef CHATGML2_6B_QUANT_ENCODER_MODEL_H
#define CHATGML2_6B_QUANT_ENCODER_MODEL_H
#include "torch/model_v2/model.h"

namespace AclTransformer {
class ChatGlm2QuantEncoderModel : public Model {
public:
    struct Param {
        bool transKey = false;
        int layerNum = 0;
    ...
    ChatGlm2QuantEncoderModel(const std::string &param);
    ~ChatGlm2QuantEncoderModel();
