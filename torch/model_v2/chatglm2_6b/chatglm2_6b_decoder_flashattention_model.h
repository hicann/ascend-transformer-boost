 ...
 */
#ifndef CHATGML2_6B_DECODER_FLASHATTENTION_MODEL_H
#define CHATGML2_6B_DECODER_FLASHATTENTION_MODEL_H
#include "torch/model_v2/model.h"

namespace AclTransformer {
class ChatGlm2DecoderFlashAttentionModel : public Model {
public:
    struct Param {
        float rmsNormEps = 0;
        int64_t headNum = 0;
    ...
    ChatGlm2DecoderFlashAttentionModel(const std::string &param);
    ~ChatGlm2DecoderFlashAttentionModel();
