 ...
 */
#ifndef CHATGML2_6B_QUANT_DECODER_MODEL_H
#define CHATGML2_6B_QUANT_DECODER_MODEL_H
#include "torch/model_v2/model.h"

namespace AclTransformer {
class ChatGlm2QuantDecoderModel : public Model {
public:
    struct Param {
        float rmsNormEps = 0;
    ...
    ChatGlm2QuantDecoderModel(const std::string &param);
    ~ChatGlm2QuantDecoderModel();
