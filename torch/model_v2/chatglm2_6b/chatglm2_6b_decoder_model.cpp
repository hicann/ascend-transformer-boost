...
void ChatGlm2DecoderModel::Param::FromString(const std::string &param)
{
...
ChatGlm2DecoderModel::~ChatGlm2DecoderModel() {}

uint64_t ChatGlm2DecoderModel::GetInTensorCount() const { return graph_.inTensors.size(); }

uint64_t ChatGlm2DecoderModel::GetOutTensorCount() const { return graph_.outTensors.size(); }

AsdOps::Status ChatGlm2DecoderModel::InferShape(const std::vector<AsdOps::Tensor> &inTensors,
...
void ChatGlm2DecoderModel::BuildGraph()
{
