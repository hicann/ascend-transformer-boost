 ...
 */
#ifndef CHATGML2_6B_DECODER_PARALLEL_MODEL_H
#define CHATGML2_6B_DECODER_PARALLEL_MODEL_H
#include "torch/model_v2/model.h"

namespace AclTransformer {
class ChatGlm2DecoderParallelModel : public Model {
public:
    struct Param {
        float rmsNormEps = 0;
    ...
    ChatGlm2DecoderParallelModel(const std::string &param);
    ~ChatGlm2DecoderParallelModel();
