 ...
 */
#ifndef CHATGML6B_DECODER_WITHOUT_FUSION_MODEL_H
#define CHATGML6B_DECODER_WITHOUT_FUSION_MODEL_H
#include "torch/model_v2/model.h"

namespace AclTransformer {
class ChatGlm6BDecoderWithoutFusionModel : public Model {
public:
    struct Param {
    ...
    ChatGlm6BDecoderWithoutFusionModel(const std::string &param);
