...
#ifndef CHATGLM6B_DECODER_QUANT_FLASH_MODEL_H
#define CHATGLM6B_DECODER_QUANT_FLASH_MODEL_H
#include "torch/model_v2/model.h"

namespace AclTransformer {
class ChatGlm6BDecoderQuantFlashModel : public Model {
public:
    struct Param {
    ...
    ChatGlm6BDecoderQuantFlashModel(const std::string &param);
    ~ChatGlm6BDecoderQuantFlashModel();
