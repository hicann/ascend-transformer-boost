 ...
 */
#ifndef CHATGML6B_ENCODER_WITHOUT_FUSION_MODEL_H
#define CHATGML6B_ENCODER_WITHOUT_FUSION_MODEL_H
#include "torch/model_v2/model.h"

namespace AclTransformer {
class ChatGlm6BEncoderWithoutFusionModel : public Model {
public:
    struct Param {
    ...
    ChatGlm6BEncoderWithoutFusionModel(const std::string &param);
    ~ChatGlm6BEncoderWithoutFusionModel();
