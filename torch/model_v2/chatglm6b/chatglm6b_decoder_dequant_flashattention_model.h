 ...
 */
#ifndef CHATGML6B_DECODER_DEQUANT_FLASHATTENTION_MODEL_H
#define CHATGML6B_DECODER_DEQUANT_FLASHATTENTION_MODEL_H
#include "torch/model_v2/model.h"

namespace AclTransformer {
class ChatGlm6BDecoderDequantFlashAttentionModel : public Model {
public:
    struct Param {
    ...
    ChatGlm6BDecoderDequantFlashAttentionModel(const std::string &param);
