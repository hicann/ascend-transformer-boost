 ...
 */
#ifndef BAICHUAN2_13B_MODELV2_ENCODER_TORCH_H
#define BAICHUAN2_13B_MODELV2_ENCODER_TORCH_H
#include "torch/model_v2/model.h"

namespace AclTransformer {
class BaiChuan213BEncoderModel : public Model {
public:
   struct Param {
       float rmsNormEps = 0;
       int headNum = 0;
   ...
   BaiChuan213BEncoderModel(const std::string &param);
    ~BaiChuan213BEncoderModel();
