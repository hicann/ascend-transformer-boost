 ...
 */
#include "baichuan2_13b_encoder_model.h"
...
void BaiChuan213BEncoderModel::Param::FromString(const std::string &param)
{
    ...
    ASD_LOG(INFO) << "BaiChuan213BEncoderModel param rmsNormEps:" << rmsNormEps << ", headNum:" << headNum
                  << ", dk:" << dk << ", layerNum:" << layerNum << ", transposedWeight:" << transposedWeight;
}

BaiChuan213BEncoderModel::BaiChuan213BEncoderModel(const std::string &param) : Model("BaiChuan213BEncoderModel", param)
{
    param_.FromString(param);
}

BaiChuan213BEncoderModel::~BaiChuan213BEncoderModel() {}

uint64_t BaiChuan213BEncoderModel::GetInTensorCount() const { return graph_.inTensors.size(); }

uint64_t BaiChuan213BEncoderModel::GetOutTensorCount() const { return graph_.outTensors.size(); }

AsdOps::Status BaiChuan213BEncoderModel::InferShape(const std::vector<AsdOps::Tensor> &inTensors,
...
void BaiChuan213BEncoderModel::BuildGraph()
{
    ...
    ASD_LOG(INFO) << "BaiChuan213BEncoderModel nodeSize is " << nodeSize;
    ...
    for (int layerId = 0; layerId < param_.layerNum; ++layerId) {
        ...
        layerNode.operation = std::make_shared<BaiChuan213BLayerEncoderOperation>(opParam);
