...
export ACLTRANSFORMER_SAVE_TENSOR_BY_RANGE=0
export ACLTRANSFORMER_SAVE_TENSOR_MIN=1
export ACLTRANSFORMER_SAVE_TENSOR_MAX=1
#export ACLTRANSFORMER_SAVE_TENSOR_RUNNER=LinearOpsRunner,AddOpsRunner
...
export ACLTRANSFORMER_PLAN_EXECUTE_ASYNC=0
export ACLTRANSFORMER_CONTEXT_HOSTTILING_RING=1
export ACLTRANSFORMER_CONTEXT_HOSTTILING_SIZE=102400
export ACLTRANSFORMER_CONTEXT_TILING_RING=1
export ACLTRANSFORMER_CONTEXT_TILING_SIZE=102400
export ACLTRANSFORMER_CONTEXT_WORKSPACE_RING=1
export ACLTRANSFORMER_CONTEXT_WORKSPACE_SIZE=629145600
export ACLTRANSFORMER_CONTEXT_INTERMEDIATE_RING=0
export ACLTRANSFORMER_CONTEXT_INTERMEDIATE_SIZE=0
export ACLTRANSFORMER_TORCH_TENSOR_FORMAT_CAST=1
export ACLTRANSFORMER_PROFILING_ENABLE=0
export ACLTRANSFORMER_TILING_COPY_STREAM_ENABLE=0