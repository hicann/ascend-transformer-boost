...
export ACLTRANSFORMER_FLASHATTENTION_USE_MULS=1
export ACLTRANSFORMER_PLAN_EXECUTE_ASYNC=0
export ACLTRANSFORMER_WORKCONTEXT_HOSTTILING_RING=28
export ACLTRANSFORMER_WORKCONTEXT_HOSTTILING_SIZE=102400
export ACLTRANSFORMER_WORKCONTEXT_TILING_RING=28
export ACLTRANSFORMER_WORKCONTEXT_TILING_SIZE=102400
export ACLTRANSFORMER_WORKCONTEXT_WORKSPACE_RING=1
export ACLTRANSFORMER_WORKCONTEXT_WORKSPACE_SIZE=102400
export ACLTRANSFORMER_WORKCONTEXT_INTERMEDIATE_RING=0
export ACLTRANSFORMER_WORKCONTEXT_INTERMEDIATE_SIZE=0