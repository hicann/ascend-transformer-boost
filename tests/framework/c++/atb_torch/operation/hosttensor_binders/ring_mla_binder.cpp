...
#                                                             self.k_split1.reshape(kv_ntokens, kv_head, 128).npu(), self.k_split2.reshape(kv_ntokens, kv_head, 128).npu(), self.v.reshape(kv_ntokens, kv_head, embeddimV).npu(),
#                                                             self.mask.to(data_type).npu(), seqlen.npu(),
#                                                             ])


#     # def test_ring_mla_bf16_512_no_mask(self):
#     #     '''
