...
# GOLDEN_SCRIPT_PATH = os.path.join(LLAMA2_13B_PATH, "patches/models/modeling_chatglm_model_precision.py")
...
class Llama2_13b_ModelTest(model_test.ModelTest):
    ...
    def generate_precision_performance(self):
        os.system(f"bash {RUN_SHELL_PATH} --precision --llama2-13b")
