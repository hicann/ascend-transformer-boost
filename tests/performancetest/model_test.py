...
class ModelTest:
    def __init__(self) -> None:
        ...
        self.file_name = self.device_type + "_performance.csv"
    ...
    def append_time(self, statistic):
        os.chdir(self.time_result_path)
        file_handle = open(self.file_name, 'a')
        file_handle.write(f"{statistic.model_name},{statistic.batch},{statistic.max_seq_len},{statistic.input_seq_len}," +
