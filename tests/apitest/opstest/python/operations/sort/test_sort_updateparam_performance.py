...
class TestSortOperation(operation_test.OperationTest):
    ...
    def test_3d_float(self):
        ...
        intensor = torch.randint(-65504, 65504,
                                 (512, 512, 8192)).float().npu().half()
        ...
        print(
            f"createOperation time: {createOperation_end_time - createOperation_start_time} second")
        ...
        for i in range(100):
            ...
            sum += execute_end_time - execute_start_time

        print(f"execute average time: {sum / 100} second")
        ...
        print(
            f"updateParam time: {updateParam_end_time - updateParam_start_time} second")
