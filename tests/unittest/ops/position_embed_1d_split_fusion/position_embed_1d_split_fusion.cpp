...
TEST(TestPositionEmbed1dSplitFusion, InferShape)
{
    ...
    AsdOps::SVector<int64_t> expectDims1 = {2, 4};
    ASSERT_EQ(expectDims1.size(), outTensorDescs.at(1).dims.size());
    EXPECT_EQ(expectDims1.at(0), outTensorDescs.at(1).dims.at(0));
    EXPECT_EQ(expectDims1.at(1), outTensorDescs.at(1).dims.at(1));
}