...
TEST(TestCastOperation, InferShapeToFp16)
{
    AclTransformer::CastOperation op;
...
TEST(TestCastOperation, InferShapeToFp32)
{
    AclTransformer::CastOperation op;
...
AsdOps::Status CastGolden(const GoldenContext &context)
{
...
TEST(TestCastOperation, TestCast)
{
