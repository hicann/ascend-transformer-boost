...
TEST(TestSelfAttentionKvCacheOperation, InferShape)
{
    ...
    AsdOps::SVector<AsdOps::SVector<int64_t>> expectDim;
    ...
    ASSERT_EQ(expectDim.at(0).size(), outTensorDescs.at(0).dims.size());
    EXPECT_EQ(expectDim.at(0).at(0), outTensorDescs.at(0).dims.at(0));
    EXPECT_EQ(expectDim.at(0).at(1), outTensorDescs.at(0).dims.at(1));
    EXPECT_EQ(expectDim.at(0).at(2), outTensorDescs.at(0).dims.at(2));
    ASSERT_EQ(expectDim.at(1).size(), outTensorDescs.at(1).dims.size());
    EXPECT_EQ(expectDim.at(1).at(0), outTensorDescs.at(1).dims.at(0));
    EXPECT_EQ(expectDim.at(1).at(1), outTensorDescs.at(1).dims.at(1));
    EXPECT_EQ(expectDim.at(1).at(2), outTensorDescs.at(1).dims.at(2));
    EXPECT_EQ(expectDim.at(1).at(3), outTensorDescs.at(1).dims.at(3));
    ASSERT_EQ(expectDim.at(2).size(), outTensorDescs.at(2).dims.size());
    EXPECT_EQ(expectDim.at(2).at(0), outTensorDescs.at(2).dims.at(0));
    EXPECT_EQ(expectDim.at(2).at(1), outTensorDescs.at(2).dims.at(1));
    EXPECT_EQ(expectDim.at(2).at(2), outTensorDescs.at(2).dims.at(2));
    EXPECT_EQ(expectDim.at(2).at(3), outTensorDescs.at(2).dims.at(3));
    // chatglm2_6b
