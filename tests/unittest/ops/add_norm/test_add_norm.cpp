...
TEST(TestAddNormOperation, InferShape)
{
    AclTransformer::AddNormParam param;
    AclTransformer::AddNormOperation op(param);
...
AsdOps::Status AddNormGolden(const GoldenContext &context)
{
    ...
    at::Tensor refOutTensor = at::layer_norm(at::add(atInRefTensor1, atInRefTensor2), atInRefTensor3.sizes(),
                                             atInRefTensor3, atInRefTensor4, layerNormEps)
                                  .contiguous();
...
TEST(TestAddNormOperation, TestAddNorm)
{
    AclTransformer::AddNormParam param;
    AclTransformer::AddNormOperation op(param);
