    ...
    bool autoFusion = false)
{
    ...
    addNode1.inTensorIds = {2, 7};
    addNode1.outTensorIds = {9};
    ...
    addNode2.outTensorIds = {10};

    atb::infer::ElewiseParam addParam;
    addParam.elewiseType = atb::infer::ElewiseParam::ElewiseType::ELEWISE_ADD;
    CreateOperation(addParam, &addNode.operation);
    addNode.inTensorIds = {9, 10};
    addNode.outTensorIds = {6};

    if (true == autoFusion) {
        atb::AutoFusion *autoFusionTool = nullptr;
        atb::CreateAutoFusionTool(opGraph, &autoFusionTool);
...
TEST(CreateMatMulAddGraphOperation, TestMatMmulAdd)
{
    ...
    context->SetAutoFusionFlag(true);
    ...
    CreateMatMulAddGraphOperation(graphParam1, &graphOp, true);
