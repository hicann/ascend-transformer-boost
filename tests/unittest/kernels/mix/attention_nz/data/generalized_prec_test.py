...
def TestFAKVbatchwisePtrCase1():
    ...
    run_unittest_cmd = "kernel_unittest --gtest_filter=TestFlashAttentionNz.FlashAttentionTestKVPtr_alibimask_dim4"
...
def TestFAKVbatchwisePtrCase2():
    ...
    os.system(gen_data_cmd)
    run_unittest_cmd = "kernel_unittest --gtest_filter=TestFlashAttentionNz.FlashAttentionTestKVPtr_alibimask_dim3"
    os.system(run_unittest_cmd)

def TestFAKVbatchwisePtrCase3():
    gen_data_cmd = "python3 unpad_FA_nz_data_gen_renew.py 2 513 8 1 32 128 2048 0 0 3 0 0"
    os.system(gen_data_cmd)
    run_unittest_cmd = "kernel_unittest --gtest_filter=TestFlashAttentionNz.FlashAttentionTestKVPtr_normmask_dim3"
    os.system(run_unittest_cmd)

def TestFAKVbatchwisePtrCase4():
    gen_data_cmd = "python3 unpad_FA_nz_data_gen_renew.py 5 1025 8 1 8 128 2048 0 0 2 0 0"
    os.system(gen_data_cmd)
    run_unittest_cmd = "kernel_unittest --gtest_filter=TestFlashAttentionNz.FlashAttentionTestKVPtr_normmask_dim2"
    os.system(run_unittest_cmd)

def TestFAKVbatchwisePtrCase5():
    gen_data_cmd = "python3 unpad_FA_nz_data_gen_renew.py 16 1024 12 1 12 128 2048 0 1 4 0 1"
    os.system(gen_data_cmd)
    run_unittest_cmd = "kernel_unittest --gtest_filter=TestFlashAttentionNz.FlashAttentionTestKVPtr_alibimask_dim4_BNSD"
    os.system(run_unittest_cmd)

def TestFAKVbatchwisePtrCase6():
    gen_data_cmd = "python3 unpad_FA_nz_data_gen_renew.py 28 88 32 1 32 128 256 0 1 3 0 1"
    os.system(gen_data_cmd)
    run_unittest_cmd = "kernel_unittest --gtest_filter=TestFlashAttentionNz.FlashAttentionTestKVPtr_alibimask_dim3_BNSD"
    os.system(run_unittest_cmd)
