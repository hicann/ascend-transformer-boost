...
def TestFAKVbatchwisePtrCase1():
    ...
    run_unittest_cmd = "kernel_unittest --gtest_filter=TestFlashAttentionNd.FlashAttentionTestKVPtr_mask1_fp16"
...
def TestFAKVbatchwisePtrCase2():
    ...
    os.system(gen_data_cmd)
    run_unittest_cmd = "kernel_unittest --gtest_filter=TestFlashAttentionNd.FlashAttentionTestKVPtr_mask1_bf16"
    os.system(run_unittest_cmd)

def TestFAKVbatchwisePtrCase3():
    gen_data_cmd = "python3 unpad_FA_data_gen_renew.py 2 513 8 1 32 128 2048 0 0 2 1 0"
    os.system(gen_data_cmd)
    run_unittest_cmd = "kernel_unittest --gtest_filter=TestFlashAttentionNd.FlashAttentionTestKVPtr_mask2_fp16"
    os.system(run_unittest_cmd)

def TestFAKVbatchwisePtrCase4():
    gen_data_cmd = "python3 unpad_FA_data_gen_renew.py 30 1025 8 1 8 128 2048 0 0 2 2 0"
    os.system(gen_data_cmd)
    run_unittest_cmd = "kernel_unittest --gtest_filter=TestFlashAttentionNd.FlashAttentionTestKVPtr_mask2_bf16"
    os.system(run_unittest_cmd)

def TestFAKVbatchwisePtrCase5():
    gen_data_cmd = "python3 unpad_FA_data_gen_renew.py 128 1367 16 1 16 128 2048 0 0 3 1 0"
    os.system(gen_data_cmd)
    run_unittest_cmd = "kernel_unittest --gtest_filter=TestFlashAttentionNd.FlashAttentionTestKVPtr_mask3_fp16"
    os.system(run_unittest_cmd)

def TestFAKVbatchwisePtrCase6():
    gen_data_cmd = "python3 unpad_FA_data_gen_renew.py 128 1634 8 1 8 128 2048 0 0 4 1 0"
    os.system(gen_data_cmd)
    run_unittest_cmd = "kernel_unittest --gtest_filter=TestFlashAttentionNd.FlashAttentionTestKVPtr_mask4_fp16"
    os.system(run_unittest_cmd)

def TestFAKVbatchwisePtrCase7():
    gen_data_cmd = "python3 unpad_FA_data_gen_renew.py 16 114 32 1 32 128 256 1 1 5 1 0"
    os.system(gen_data_cmd)
    run_unittest_cmd = "kernel_unittest --gtest_filter=TestFlashAttentionNd.FlashAttentionTestKVPtr_mask5_fp16"
    os.system(run_unittest_cmd)
