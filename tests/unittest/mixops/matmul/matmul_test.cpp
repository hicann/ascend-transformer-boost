...
#include "ops/matmul/tiling/pp_matmul_i8_nz_tiling.h"
#include "ops/matmul/tiling/pp_matmul_tiling.h"
#include "ops/matmul/tiling/pp_matmul_mix_tiling.h"
#include "ops/matmul/tiling/matmul_nd_tiling.h"
#include "ops/matmul/tiling/matmul_nz_tiling.h"
...
TEST(TestMatMulNz, MatMulNzNoTrans1)
{
    ...
    opTest.Golden(std::bind(MatMulNzGolden, ATOL, RTOL, opParam, std::placeholders::_1));
    opTest.FloatRand(HALF_FLOAT_MIN, HALF_FLOAT_MAX);
    Mki::Test::UtOpDesc opDesc = {"MatMulOperation", opParam};

    SVector<TensorDesc> inTensorDesc = {{TENSOR_DTYPE_FLOAT16, TENSOR_FORMAT_FRACTAL_NZ, {1, k1, m1 * mkn0, mkn0}},
                                        {TENSOR_DTYPE_FLOAT16, TENSOR_FORMAT_FRACTAL_NZ, {1, n1, k1 * mkn0, mkn0}}};
    Status status = opTest.Run(opDesc, inTensorDesc);
    setenv(ENV_MATMUL_PP_FLAG, "1", 1);
    ASSERT_EQ(status.Ok(), true);
}

TEST(TestMatMulNz, MatMulNzTransA1)
{
    setenv(ENV_MATMUL_PP_FLAG, "0", 1);
    int64_t m1 = 15;
    int64_t k1 = 31;
    ...
    SVector<TensorDesc> inTensorDesc = {{TENSOR_DTYPE_FLOAT16, TENSOR_FORMAT_FRACTAL_NZ, {1, m1, k1 * mkn0, mkn0}},
                                        {TENSOR_DTYPE_FLOAT16, TENSOR_FORMAT_FRACTAL_NZ, {1, n1, k1 * mkn0, mkn0}}};
    Status status = opTest.Run(opDesc, inTensorDesc);
    setenv(ENV_MATMUL_PP_FLAG, "1", 1);
    ASSERT_EQ(status.Ok(), true);
...
TEST(TestMatMulNz, MatMulNzTransB1)
{
    setenv(ENV_MATMUL_PP_FLAG, "0", 1);
    int64_t m1 = 28;
    int64_t k1 = 15;
    ...
    SVector<TensorDesc> inTensorDesc = {{TENSOR_DTYPE_FLOAT16, TENSOR_FORMAT_FRACTAL_NZ, {1, k1, m1 * mkn0, mkn0}},
                                        {TENSOR_DTYPE_FLOAT16, TENSOR_FORMAT_FRACTAL_NZ, {1, k1, n1 * mkn0, mkn0}}};
    Status status = opTest.Run(opDesc, inTensorDesc);
    setenv(ENV_MATMUL_PP_FLAG, "1", 1);
    ASSERT_EQ(status.Ok(), true);
}

TEST(TestMatMulNz, MatMulNzTransAB1)
{
    setenv(ENV_MATMUL_PP_FLAG, "0", 1);
    int64_t m1 = 31;
    int64_t k1 = 28;
...
TEST(TestMatMulNz, BatchMatMulNzNoTrans1)
{
    setenv(ENV_MATMUL_PP_FLAG, "0", 1);
    int64_t b = 32;
    int64_t m1 = 32;
    ...
    SVector<TensorDesc> inTensorDesc = {{TENSOR_DTYPE_FLOAT16, TENSOR_FORMAT_FRACTAL_NZ, {b, k1, m1 * mkn0, mkn0}},
                                        {TENSOR_DTYPE_FLOAT16, TENSOR_FORMAT_FRACTAL_NZ, {b, n1, k1 * mkn0, mkn0}}};
    Status status = opTest.Run(opDesc, inTensorDesc);
    setenv(ENV_MATMUL_PP_FLAG, "1", 1);
    ASSERT_EQ(status.Ok(), true);
}

TEST(TestMatMulNz, BatchMatMulNzTransA1)
{
    setenv(ENV_MATMUL_PP_FLAG, "0", 1);
    int64_t b = 8;
    int64_t m1 = 15;
    ...
    SVector<TensorDesc> inTensorDesc = {{TENSOR_DTYPE_FLOAT16, TENSOR_FORMAT_FRACTAL_NZ, {b, m1, k1 * mkn0, mkn0}},
                                        {TENSOR_DTYPE_FLOAT16, TENSOR_FORMAT_FRACTAL_NZ, {b, n1, k1 * mkn0, mkn0}}};
    Status status = opTest.Run(opDesc, inTensorDesc);
    setenv(ENV_MATMUL_PP_FLAG, "1", 1);
    ASSERT_EQ(status.Ok(), true);
...
TEST(TestMatMulNz, BatchMatMulNzTransB1)
{
    setenv(ENV_MATMUL_PP_FLAG, "0", 1);
    int64_t b = 8;
    int64_t m1 = 28;
    ...
    SVector<TensorDesc> inTensorDesc = {{TENSOR_DTYPE_FLOAT16, TENSOR_FORMAT_FRACTAL_NZ, {b, k1, m1 * mkn0, mkn0}},
                                        {TENSOR_DTYPE_FLOAT16, TENSOR_FORMAT_FRACTAL_NZ, {b, k1, n1 * mkn0, mkn0}}};
    Status status = opTest.Run(opDesc, inTensorDesc);
    setenv(ENV_MATMUL_PP_FLAG, "1", 1);
    ASSERT_EQ(status.Ok(), true);
}

TEST(TestMatMulNz, BatchMatMulNzTransAB1)
{
    setenv(ENV_MATMUL_PP_FLAG, "0", 1);
    int64_t b = 8;
    int64_t m1 = 31;
