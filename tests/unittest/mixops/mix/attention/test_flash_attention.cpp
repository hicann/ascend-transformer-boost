...
TEST(TestFlashAttentionNd, FlashAttentionTestKVPtr_mask1_fp16)
{
    ...
    std::string dataGen = "python3 " + atbopsHomeDir + "/../../../tests/unittest/mixops/mix/" +
...
TEST(TestFlashAttentionNd, FlashAttentionTestKVPtr_relayAttention_case1)
{
    ...
    std::ofstream shareIdxBin(atbopsHomeDir + "/../../../tests/unittest/mixops/mix/" + subDir + "/data/share_idx.bin", std::ios::binary);
    shareIdxBin.write((const char *)shareIdx.data(), shareIdx.size() * sizeof(int));
    shareIdxBin.close();
    std::ofstream shareLenBin(atbopsHomeDir + "/../../../tests/unittest/mixops/mix/" + subDir + "/data/share_len.bin", std::ios::binary);
