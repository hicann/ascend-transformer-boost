...
#include "atbops/params/norm.h"
#include "mixops/norm/postlayernorm/tiling/post_layer_norm_tiling.h"
...
Status PostLayerNormGolden(float atol, float rtol, OpParam::Norm opParam, const GoldenContext &context)
{
...
TEST(PostLayerNormF16, PostLayerNormF16CanSupport)
{
    ...
    opParam.inBeta = true;
    UtOpDesc opDesc = {"NormOperation", opParam};
...
TEST(PostLayerNormF16, PostLayerNormF16op1)
{
    ...
    uint32_t b = 6656;
    MkiOpTest opTest;
    AtbOps::OpParam::Norm opParam;
    UtOpDesc opDesc;
    opDesc.opName = "NormOperation";
    opParam.epsilon = 0.00001;
    opParam.opsMode = 0;
    opParam.zoomScaleValue = 1;
    opParam.normType = AtbOps::OpParam::Norm::LAYER_NORM;
    opParam.inRes = true;
    opParam.inGamma = true;
    opParam.inBeta = true;
