...
Status AddGolden(const GoldenContext &context)
{
...
Status AddF16Golden(const GoldenContext &context)
{
    const Tensor &inTensor1 = context.hostInTensors.at(0);
...
TEST(TestOpElewiseAdd, TestOpElewiseAddCaseAutoTiling)
{
    ...
    UtOpDesc opDesc = {"ElewiseOperation", opParam};
    UtOpDesc opDesc1 = {"ElewiseOperation", opParam};
    UtOpDesc opDesc2 = {"ElewiseOperation", opParam};
    int64_t n = 233, k = 666;
