...
Status MulsF32Compare(float scale, float atol, float rtol, const GoldenContext &context)
{
...
Status MulsF16Compare(float scale, float atol, float rtol, const GoldenContext &context)
{
    const Tensor &inTensor = context.hostInTensors.at(0);
