...
#include "atbops/params/activation.h"
...
TEST(TestOpActivationRelu, TestActivationReluF32RandCaseAutoTiling)
{
    ...
    MkiOpTest opTest1;
    opTest1.Golden(std::bind(&Golden::InOutTensorEqual, ATOL, RTOL, std::placeholders::_1));
    UtOpDesc opDesc1 = {"ActivationOperation", opParam};

    MkiOpTest opTest2;
    opTest1.Golden(std::bind(&Golden::InOutTensorEqual, ATOL, RTOL, std::placeholders::_1));
    UtOpDesc opDesc2 = {"ActivationOperation", opParam};
