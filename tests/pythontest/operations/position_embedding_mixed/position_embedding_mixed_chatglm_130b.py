...
PARAM = {"headNum": 32, "model": "chatglm130b"}

INTENSOR0 = os.path.join(os.getenv("ACLTRANSFORMER_TESTDATA"),
                         "tensors/operations/position_embedding_mixed/chatglm6b", "inTensor0.bin")
INTENSOR1 = os.path.join(os.getenv("ACLTRANSFORMER_TESTDATA"),
                         "tensors/operations/position_embedding_mixed/chatglm6b", "inTensor1.bin")
INTENSOR2 = os.path.join(os.getenv("ACLTRANSFORMER_TESTDATA"),
                         "tensors/operations/position_embedding_mixed/chatglm6b", "inTensor2.bin")
INTENSOR3 = os.path.join(os.getenv("ACLTRANSFORMER_TESTDATA"),
                         "tensors/operations/position_embedding_mixed/chatglm6b", "inTensor3.bin")

OUTTENSOR0 = os.path.join(os.getenv("ACLTRANSFORMER_TESTDATA"),
                         "tensors/operations/position_embedding_mixed/chatglm6b", "outTensor0.bin")
OUTTENSOR1 = os.path.join(os.getenv("ACLTRANSFORMER_TESTDATA"),
                         "tensors/operations/position_embedding_mixed/chatglm6b", "outTensor1.bin")
...
class TestPositionEmbeddingMixedGlm130B(operation_test.OperationTest):
