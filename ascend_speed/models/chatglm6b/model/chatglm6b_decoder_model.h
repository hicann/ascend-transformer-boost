 ...
 */
#ifndef ATB_SPEED_MODELS_CHATGML6B_DECODER_MODEL_H
#define ATB_SPEED_MODELS_CHATGML6B_DECODER_MODEL_H
#include <atb/svector.h>
#include "atb_speed/base/model.h"

namespace atb_speed {
class ChatGlm6BDecoderModel : public Model {
public:
    struct Param {
    ...
    ChatGlm6BDecoderModel(const std::string &param);
