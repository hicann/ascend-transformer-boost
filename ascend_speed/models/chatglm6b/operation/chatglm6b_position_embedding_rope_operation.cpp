                                                      ...
                                                      atb::Operation **operation)
{
    ...
    CreateOp(splitQKVParam, &splitQKVNode.op);
    ...
    CreateOp(splitPositionIdsParam, &splitPositionIdsNode.op);
    ...
    CreateOp(transposePositionIds0Param, &transposePositionIds0Node.op);
    ...
    CreateOp(transposePositionIds1Param, &transposePositionIds1Node.op);
    ...
    CreateOp(embeddingCos0Param, &embeddingCos0Node.op);
    ...
    CreateOp(embeddingCos1Param, &embeddingCos1Node.op);
    ...
    CreateOp(embeddingSin0Param, &embeddingSin0Node.op);
    ...
    CreateOp(embeddingSin1Param, &embeddingSin1Node.op);
    ...
    CreateOp(concateCosParam, &concateCosNode.op);
    ...
    CreateOp(concateSinParam, &concateSinNode.op);
