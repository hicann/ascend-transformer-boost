...
public:
    ...
    atb::Status Execute(aclrtStream stream, std::vector<atb::Tensor> &inTensors, std::vector<atb::Tensor> &outTensors,
                        const std::string &param);

    // template <typename ModelParam> atb::Status CreateModel(const ModelParam &modelParam, Model **);
