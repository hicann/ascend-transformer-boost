...
BufferDevice::BufferDevice(uint64_t bufferSize) : bufferSize_(bufferSize)
{
    ...
    if (bufferSize_ > 0) {
        ASD_LOG(INFO) << "BufferDevice::GetBuffer AsdRtMemMallocDevice bufferSize:" << bufferSize_;
...
void *BufferDevice::GetBuffer(uint64_t bufferSize)
{
    ...
    ASD_LOG(INFO) << "BufferDevice::GetBuffer AsdRtMemMallocDevice bufferSize:" << bufferSize;
