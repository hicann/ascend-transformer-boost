...
enum RunnerType {
    ...
    RUNNER_TYPE_POSITION_EMBEDDING_1D_FUSION,
    RUNNER_TYPE_POSITION_EMBEDDING_1D_MIXED,
    RUNNER_TYPE_POSITION_EMBEDDING_1D_MIXED_FUSION,
    RUNNER_TYPE_POSITION_EMBEDDING_2D_MIXED,
    RUNNER_TYPE_POSITION_EMBEDDING_2D_MIXED_FUSION,
    RUNNER_TYPE_RMS_NORM,
    RUNNER_TYPE_RMS_NORM_QUANT,
    RUNNER_TYPE_RMS_PRE_NORM_QUANT,
    ...
    RUNNER_TYPE_SELF_ATTENTION_CROSS,
    RUNNER_TYPE_TRANSPOSE,
    RUNNER_TYPE_ADD_NORM_QUANT,
    RUNNER_TYPE_NORM_QUANT,
    ...
    RUNNER_TYPE_MULTI_LAYER_LINEAR,
    RUNNER_TYPE_MAX
};
} // namespace AclTransformer
#endif