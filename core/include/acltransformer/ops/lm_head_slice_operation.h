 ...
 */
#ifndef ACLTRANSFORMER_LMHEAD_SLICE_OPERATION_H
#define ACLTRANSFORMER_LMHEAD_SLICE_OPERATION_H
#include "acltransformer/graph_operation.h"
#include "acltransformer/params/lm_head_slice.h"

namespace AclTransformer {
class LmHeadSliceOperation : public Operation {
public:
    LmHeadSliceOperation(const LmHeadSliceParam &param);
    virtual ~LmHeadSliceOperation();
