 ...
 */
#ifndef ACLTRANSFORMER_RMSPRENORMQUANT_OPERATION_H
#define ACLTRANSFORMER_RMSPRENORMQUANT_OPERATION_H
#include "acltransformer/operation.h"
#include "acltransformer/params/rms_pre_norm_quant.h"

namespace AclTransformer {
class RmsPreNormQuantOperation : public Operation {
public:
    RmsPreNormQuantOperation(const RmsPreNormQuantParam &param);
    virtual ~RmsPreNormQuantOperation();
