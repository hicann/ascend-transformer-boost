 ...
 */
#ifndef ACLTRANSFORMER_RMSNORM_OPERATION_H
#define ACLTRANSFORMER_RMSNORM_OPERATION_H
#include "acltransformer/operation.h"
#include "acltransformer/params/rms_norm.h"

namespace AclTransformer {
class RmsNormOperation : public Operation {
public:
    RmsNormOperation(const RmsNormParam &param);
    virtual ~RmsNormOperation();
