 ...
 */
#ifndef ACLTRANSFORMER_POST_SAMPLING_OPERATION_H
#define ACLTRANSFORMER_POST_SAMPLING_OPERATION_H
#include "acltransformer/operation.h"
#include "acltransformer/params/post_sampling.h"

namespace AclTransformer {
class PostSamplingOperation : public Operation {
public:
    PostSamplingOperation(const PostSamplingParam &param);
    virtual ~PostSamplingOperation();
