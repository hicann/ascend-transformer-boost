 ...
 */
#ifndef ACLTRANSFORMER_LM_HEAD_OPERATION_H
#define ACLTRANSFORMER_LM_HEAD_OPERATION_H
#include "acltransformer/graph_operation.h"
#include "acltransformer/params/lm_head.h"

namespace AclTransformer {
class LmHeadOperation : public GraphOperation {
public:
    LmHeadOperation(const LmHeadParam &param);
    virtual ~LmHeadOperation();
