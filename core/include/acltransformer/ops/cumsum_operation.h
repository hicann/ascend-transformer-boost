 ...
 *  */
#ifndef ACLTRANSFORMER_CUMSUM_OPERATION_H
#define ACLTRANSFORMER_CUMSUM_OPERATION_H
#include "acltransformer/operation.h"
#include "acltransformer/params/cumsum.h"

namespace AclTransformer {
class CumsumOperation : public Operation {
public:
    CumsumOperation(const CumsumParam &param);
    virtual ~CumsumOperation();
