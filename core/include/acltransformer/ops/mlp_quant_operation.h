 ...
 */
#ifndef ACLTRANSFORMER_MLP_QUANT_OPERATION_H
#define ACLTRANSFORMER_MLP_QUANT_OPERATION_H
#include "acltransformer/operation.h"
#include "acltransformer/params/mlp_quant.h"

namespace AclTransformer {
class MlpQuantOperation : public Operation {
public:
    MlpQuantOperation(const MlpQuantParam &param);
    virtual ~MlpQuantOperation();
