 ...
 */
#ifndef ACLTRANSFORMER_POSITION_EMBEDDING_1D_SPLIT_FUSION_OPERATION_H
#define ACLTRANSFORMER_POSITION_EMBEDDING_1D_SPLIT_FUSION_OPERATION_H
#include "acltransformer/operation.h"
#include "acltransformer/params/position_embedding_1d_fusion.h"

namespace AclTransformer {
class PositionEmbedding1dSplitFusionOperation : public Operation {
public:
    PositionEmbedding1dSplitFusionOperation(const PositionEmbedding1dFusionParam &param);
    virtual ~PositionEmbedding1dSplitFusionOperation();
