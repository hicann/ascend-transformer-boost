 ...
 */
#ifndef ACLTRANSFORMER_ALL_REDUCE_OPERATION_H
#define ACLTRANSFORMER_ALL_REDUCE_OPERATION_H
#include "acltransformer/operation.h"
#include "acltransformer/params/all_reduce.h"

namespace AclTransformer {
class AllReduceOperation : public Operation {
public:
    AllReduceOperation(const AllReduceParam &param);
    ~AllReduceOperation();
