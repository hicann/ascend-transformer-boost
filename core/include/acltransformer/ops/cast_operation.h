 ...
 */
#ifndef ACLTRANSFORMER_CAST_OPERATION_H
#define ACLTRANSFORMER_CAST_OPERATION_H
#include "acltransformer/operation.h"

namespace AclTransformer {
// If input is fp16, output is fp32. If input is fp32, output is fp16. Do not support other dtype now
