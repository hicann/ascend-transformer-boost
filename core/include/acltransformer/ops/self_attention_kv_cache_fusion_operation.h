 ...
 */
#ifndef ACLTRANSFORMER_SELFATTENTION_KV_CACHE_FUSION_OPERATION_H
#define ACLTRANSFORMER_SELFATTENTION_KV_CACHE_FUSION_OPERATION_H
#include "acltransformer/operation.h"
#include "acltransformer/params/self_attention_kv_cache_fusion.h"

namespace AclTransformer {
class SelfAttentionKvCacheFusionOperation : public Operation {
public:
    SelfAttentionKvCacheFusionOperation (const SelfAttentionKvCacheFusionParam &param);
