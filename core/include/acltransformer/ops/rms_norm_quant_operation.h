 ...
 */
#ifndef ACLTRANSFORMER_RMSNORM_QUANT_OPERATION_H
#define ACLTRANSFORMER_RMSNORM_QUANT_OPERATION_H
#include "acltransformer/operation.h"
#include "acltransformer/params/rms_norm_quant.h"

namespace AclTransformer {
class RmsNormQuantOperation : public Operation {
public:
    RmsNormQuantOperation(const RmsNormQuantParam &param);
    virtual ~RmsNormQuantOperation();
