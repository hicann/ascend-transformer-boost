 ...
 */
#ifndef ACLTRANSFORMER_TRANSDATAINT8_OPERATION_H
#define ACLTRANSFORMER_TRANSDATAINT8_OPERATION_H
#include "acltransformer/operation.h"
#include "acltransformer/params/transdata_int8.h"

namespace AclTransformer {
class TransDataInt8Operation : public Operation {
public:
    TransDataInt8Operation(const TransDataInt8Param &param);
    virtual ~TransDataInt8Operation();
