 ...
 */
#ifndef ACLTRANSFORMER_SELFATTENTION_CROSS_OPERATION_H
#define ACLTRANSFORMER_SELFATTENTION_CROSS_OPERATION_H
#include "acltransformer/operation.h"
#include "acltransformer/params/self_attention_cross.h"

namespace AclTransformer {
class SelfAttentionCrossOperation : public Operation {
public:
    SelfAttentionCrossOperation(const SelfAttentionCrossParam &param);
    ~SelfAttentionCrossOperation();
