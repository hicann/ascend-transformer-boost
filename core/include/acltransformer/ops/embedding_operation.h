 ...
 */
#ifndef ACLTRANSFORMER_EMBEDDING_OPERATION_H
#define ACLTRANSFORMER_EMBEDDING_OPERATION_H
#include "acltransformer/operation.h"
#include "acltransformer/params/embedding.h"

namespace AclTransformer {
class EmbeddingOperation : public Operation {
public:
    EmbeddingOperation(const EmbeddingParam &param);
    virtual ~EmbeddingOperation();
