 ...
 */
#ifndef ACLTRANSFORMER_LINEAR_PARALLEL_OPERATION_H
#define ACLTRANSFORMER_LINEAR_PARALLEL_OPERATION_H
#include "acltransformer/graph_operation.h"
#include "acltransformer/params/linear_parallel.h"

namespace AclTransformer {
class LinearParallelOperation : public GraphOperation {
public:
    LinearParallelOperation(const LinearParallelParam &param);
    virtual ~LinearParallelOperation();
