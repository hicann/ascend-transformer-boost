 ...
 */
#ifndef ACLTRANSFORMER_SLICE_OPERATION_H
#define ACLTRANSFORMER_SLICE_OPERATION_H
...
public:
    SliceOperation(const SliceParam &param);
    virtual ~SliceOperation();
    uint64_t GetInTensorCount() const override;
    uint64_t GetOutTensorCount() const override;

protected:
    AsdOps::Status InferShapeImpl(const AsdOps::SVector<AsdOps::Tensor> &xTensors,
