 ...
 */
#ifndef ACLTRANSFORMER_DEQUANT_OPERATION_H
#define ACLTRANSFORMER_DEQUANT_OPERATION_H
#include "acltransformer/operation.h"
#include "acltransformer/params/dequant.h"

namespace AclTransformer {
class DequantOperation : public Operation {
public:
    DequantOperation(const DequantParam &param);
    ~DequantOperation();
