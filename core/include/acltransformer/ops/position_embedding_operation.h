 ...
 */
#ifndef ACLTRANSFORMER_POSITION_EMBEDDING_OPERATION_H
#define ACLTRANSFORMER_POSITION_EMBEDDING_OPERATION_H
#include "acltransformer/operation.h"
#include "acltransformer/params/position_embedding.h"

namespace AclTransformer {
class PositionEmbeddingOperation : public Operation {
public:
