 ...
 */
#ifndef ACLTRANSFORMER_MULTINOMIAL_OPERATION_H
#define ACLTRANSFORMER_MULTINOMIAL_OPERATION_H
#include "acltransformer/operation.h"
#include "acltransformer/params/multinomial.h"

namespace AclTransformer {
class MultinomialOperation : public Operation {
public:
    MultinomialOperation(const MultinomialParam &param);
    virtual ~MultinomialOperation();
