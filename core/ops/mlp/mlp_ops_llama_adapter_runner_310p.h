 ...
 */
#ifndef MLP_OPS_LLAMA_ADAPTER_RUNNER_310P_H
#define MLP_OPS_LLAMA_ADAPTER_RUNNER_310P_H
#include "acltransformer/base/ops_runner.h"
#include "acltransformer/params/mlp.h"

namespace AclTransformer {
class MlpOpsLlamaAdapterRunner310P : public OpsRunner {
public:
    explicit MlpOpsLlamaAdapterRunner310P(const MlpParam &param);
    virtual ~MlpOpsLlamaAdapterRunner310P();
