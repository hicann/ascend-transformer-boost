...
MlpOpsLlama13bRunner::MlpOpsLlama13bRunner(const MlpParam &param) : OpsRunner("MlpOpsLlama13bRunner", RUNNER_TYPE_MLP), param_(param)
{
    ASD_LOG(INFO) << "MlpOpsLlama13bRunner::MlpOpsLlama13bRunner called";

    const std::size_t inTensorSize = 3;
    const std::size_t outTensorSize = 1;
    const std::size_t internalTensorSize = 3;
...
MlpOpsLlama13bRunner::~MlpOpsLlama13bRunner() {}
} // namespace AclTransformer
