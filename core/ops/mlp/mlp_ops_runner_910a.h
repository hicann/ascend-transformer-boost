 ...
 */
#ifndef MLP_OPS_RUNNER_910A_H
#define MLP_OPS_RUNNER_910A_H
#include "acltransformer/base/ops_runner.h"
#include "acltransformer/params/mlp.h"

namespace AclTransformer {
class MlpOpsRunner910A : public OpsRunner {
public:
    explicit MlpOpsRunner910A(const MlpParam &param);
    virtual ~MlpOpsRunner910A();
