...
class PositionEmbeddingFusionGatherOpsRunner : public OpsRunner {
public:
    explicit PositionEmbeddingFusionGatherOpsRunner(const PositionEmbeddingFusionParam &param);
    virtual ~PositionEmbeddingFusionGatherOpsRunner();
