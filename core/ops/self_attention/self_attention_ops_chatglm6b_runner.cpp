    ...
    : OpsRunner("SelfAttentionOpsChatglm6bRunner", RUNNER_TYPE_SELF_ATTENTION), param_(param)
{
    ...
    AsdOps::Tensor &transposedV = kernelGraph_.internalTensors.at(7);
    ...
    auto &mulsMaskOutNode = kernelGraph_.nodes.at(5);
    auto &softMaxNode = kernelGraph_.nodes.at(6);
    auto &permuteVNode = kernelGraph_.nodes.at(7);
    auto &bmmVNode = kernelGraph_.nodes.at(8);
    auto &permuteContextNode = kernelGraph_.nodes.at(9);
