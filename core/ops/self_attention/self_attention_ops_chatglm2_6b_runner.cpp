...
SelfAttentionOpsChatglm26bRunner::SelfAttentionOpsChatglm26bRunner(const SelfAttentionParam &param)
    : OpsRunner("SelfAttentionOpsChatGlm26bRunner", RUNNER_TYPE_SELF_ATTENTION), param_(param)
{
        ASD_LOG(INFO) << "SelfAttentionOpsChatGlm26bRunner::SelfAttentionOpsChatGlm26bRunner called"
                  ...
                  << ", num_attention_heads_per_partition" << param_.num_attention_heads_per_partition
                  << ", hidden_size_per_attention_head " << param_.hidden_size_per_attention_head
                  << ", num_multi_query_groups_per_partition" << param_.num_multi_query_groups_per_partition << ", model " << param_.model;
        ...
        const int internalTensorSize = 11;
        ...
        int64_t np = param_.num_attention_heads_per_partition;
        int64_t hn = param_.hidden_size_per_attention_head;
        int64_t gp = param_.num_multi_query_groups_per_partition;
...
SelfAttentionOpsChatglm26bRunner::~SelfAttentionOpsChatglm26bRunner() {}
} // namespace AclTransformer
