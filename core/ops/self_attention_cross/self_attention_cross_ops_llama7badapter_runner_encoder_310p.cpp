...
SelfAttentionCrossOpsLlama7bAdapterRunnerEncoder310p::SelfAttentionCrossOpsLlama7bAdapterRunnerEncoder310p(const SelfAttentionCrossParam &param)
    : OpsRunner("SelfAttentionCrossOpsLlama7bAdapterRunnerEncoder310p", RUNNER_TYPE_SELF_ATTENTION_CROSS), param_(param)
{
    ASD_LOG(INFO) << "SelfAttentionCrossOpsLlama7bAdapterRunnerEncoder310p::SelfAttentionCrossOpsLlama7bAdapterRunnerEncoder310p called "
    ...
    getpastKeyNode.inTensorViewFuncs.resize(getpastKeyNode.inTensors.size());
    ...
    getpastValueNode.inTensorViewFuncs.resize(getpastValueNode.inTensors.size());
...
SelfAttentionCrossOpsLlama7bAdapterRunnerEncoder310p::~SelfAttentionCrossOpsLlama7bAdapterRunnerEncoder310p() {}

void SelfAttentionCrossOpsLlama7bAdapterRunnerEncoder310p::AsStrideKernelInferShapeSet(const AsdOps::SVector<int64_t> &sequence,
