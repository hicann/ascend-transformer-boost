 ...
 */
#include "self_attention_cross_ops_llama7badapter_runner_encoder_adapter_310p.h"
#include <numeric>
#include <cmath>
...
SelfAttentionCrossOpsLlama7bAdapterRunnerEncoderAdapter310p::SelfAttentionCrossOpsLlama7bAdapterRunnerEncoderAdapter310p(const SelfAttentionCrossParam &param)
    : OpsRunner("SelfAttentionCrossOpsLlama7bAdapterRunnerEncoderAdapter310p", RUNNER_TYPE_SELF_ATTENTION_CROSS), param_(param)
{
    ASD_LOG(INFO) << "SelfAttentionCrossOpsLlama7bAdapterRunnerEncoderAdapter310p::SelfAttentionCrossOpsLlama7bAdapterRunnerEncoderAdapter310p called "
    ...
    auto &getpastKeyNode = kernelGraph_.nodes.at(nodeNum++);
    auto &getpastValueNode = kernelGraph_.nodes.at(nodeNum++);
    auto &permuteKeyNode = kernelGraph_.nodes.at(nodeNum++);
    auto &permuteValuesNode = kernelGraph_.nodes.at(nodeNum++);
    auto &permuteAdapterVNode = kernelGraph_.nodes.at(nodeNum++);
    ...
    auto &transdataAKNode = kernelGraph_.nodes.at(nodeNum++);
    ...
    auto &mulsTanhNode = kernelGraph_.nodes.at(nodeNum++);
    ...
    AsdOps::OpParam::Transpose getpastKeyParam = {AsdOps::OpParam::Transpose::TransposeType::TRANSPOSE, {0, 1, 2, 3}};
    getpastKeyNode.opDesc = {0, "TransposeOperation", getpastKeyParam};
    getpastKeyNode.inTensors = {&xk};
    getpastKeyNode.outTensors = {&curKeysOut};

    AsdOps::OpParam::Transpose getpastValueParam = {AsdOps::OpParam::Transpose::TransposeType::TRANSPOSE, {0, 1, 2, 3}};
    getpastValueNode.opDesc = {0, "TransposeOperation", getpastValueParam};
    getpastValueNode.inTensors = {&xv};
    getpastValueNode.outTensors = {&curValuesOut};
...
SelfAttentionCrossOpsLlama7bAdapterRunnerEncoderAdapter310p::~SelfAttentionCrossOpsLlama7bAdapterRunnerEncoderAdapter310p() {}
} // namespace AclTransformer