...
MlpQuantOpsGlm2Runner910b::MlpQuantOpsGlm2Runner910b(const MlpQuantParam &param)
    : OpsRunner("MlpQuantOpsGlm2Runner910b", RUNNER_TYPE_MLP_QUANT), param_(param)
{
    ASD_LOG(INFO) << "MlpQuantOpsGlm2Runner910b::MlpQuantOpsGlm2Runner910b called";
    ...
    matmulUpNode.inTensors = {&hiddenStates, &weightUp, &biasUp, &deqScaleUp};
    ...
    quantNode.opDesc = {0, "ElewiseOperation", AsdOps::OpParam::Elewise({
    ...
    ASD_LOG(INFO) << "MlpQuantOpsGlm2Runner910b::MlpQuantOpsGlm2Runner910b END";
}

MlpQuantOpsGlm2Runner910b::~MlpQuantOpsGlm2Runner910b() {}
} // namespace AclTransformer
