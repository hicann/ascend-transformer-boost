    ...
    : OpsRunner("PositionEmbedding1dOpsLlama7bRunner", RUNNER_TYPE_POSITION_EMBEDDING_1D_MIXED), param_(param)
{
    ...
    AsdOps::OpParam::Transpose qTransposeNode1Param = {AsdOps::OpParam::Transpose::TransposeType::TRANSPOSE, {0, 2, 1, 3}};
    ...
    AsdOps::OpParam::Transpose kTransposeNode1Param = {AsdOps::OpParam::Transpose::TransposeType::TRANSPOSE, {0, 2, 1, 3}};
