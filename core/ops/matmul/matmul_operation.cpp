...
uint64_t MatmulOperation::GetInTensorCount() const { return 2; }

uint64_t MatmulOperation::GetOutTensorCount() const { return 1; }
...
RunnerBuilder *MatmulOperation::FindBestRunnerBuilder() const { return runnerBuilders_.at(0); }
