...
: OpsRunner("SelfAttentionKvCacheOpsChatGlm26bRunner310P", RUNNER_TYPE_SELF_ATTENTION_KV_CACHE), param_(param)
{
    ...
    mulsMaskOutNode.inTensors = {&bmmQkOutTransResult};
...
SelfAttentionKvCacheOpsChatGlm26bRunner310P::~SelfAttentionKvCacheOpsChatGlm26bRunner310P() {}
} // namespace AclTransformer