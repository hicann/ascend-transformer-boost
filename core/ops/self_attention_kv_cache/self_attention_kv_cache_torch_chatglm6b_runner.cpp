                                                                     ...
                                                                     VariantPack &variantPack)
{
    ...
    if (!TorchUtil::IsTensorDimEqual(presentKey.sizes(), variantPack.outTensors[1].desc.dims)) {
    ...
    if (!TorchUtil::IsTensorDimEqual(presentValue.sizes(), variantPack.outTensors[2].desc.dims)) {
