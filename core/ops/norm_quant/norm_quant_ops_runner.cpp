...
NormQuantOpsRunner::NormQuantOpsRunner(const NormQuantParam &param)
    : OpsRunner("NormQuantOpsRunner", RUNNER_TYPE_NORM_QUANT), param_(param)
{
    ASD_LOG(INFO) << "NormQuantOpsRunner::NormQuantOpsRunner";
...
NormQuantOpsRunner::~NormQuantOpsRunner() {}
} // namespace AclTransformer
