...
const std::size_t IN_TENSOR_SIZE = 4;
const std::size_t OUT_TENSOR_SIZE = 3;
const std::size_t INTER_TENSOR_SIZE = 2;
const std::size_t NODE_SIZE = 2;
const std::int32_t KQV_SLICE_SIZE = 3;
    ...
    : OpsRunner("PositionEmbeddingFusionRopeOpsRunner", RUNNER_TYPE_POSITION_EMBEDDING_2D_MIXED_FUSION), param_(param)
{
    ...
    int64_t tempInTensorNum = 0;
    AsdOps::Tensor &mixedQkv = kernelGraph_.inTensors.at(tempInTensorNum++);
    ...
    int64_t tempOutTensorNum = 0;
    AsdOps::Tensor &qEmbedded = kernelGraph_.outTensors.at(tempOutTensorNum++);
    AsdOps::Tensor &kEmbedded = kernelGraph_.outTensors.at(tempOutTensorNum++);
    AsdOps::Tensor &value = kernelGraph_.outTensors.at(tempOutTensorNum++);  // V
