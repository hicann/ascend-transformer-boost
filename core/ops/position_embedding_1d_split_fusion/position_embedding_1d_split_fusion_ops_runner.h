...
class PositionEmbedding1dFusionOpsRunner : public OpsRunner {
public:
    explicit PositionEmbedding1dFusionOpsRunner(const PositionEmbedding1dFusionParam &param);
    virtual ~PositionEmbedding1dFusionOpsRunner();
