 ...
 */
#include "self_attention_kv_cache_fusion_ops_llama13b_runner.h"
#include <numeric>
#include <cmath>
...
SelfAttentionKvCacheFusionOpsLlama13bRunner::SelfAttentionKvCacheFusionOpsLlama13bRunner(
    const SelfAttentionKvCacheFusionParam &param)
    : OpsRunner("SelfAttentionKvCacheFusionOpsLlama13bRunner", RUNNER_TYPE_SELF_ATTENTION_KV_FUSION_CACHE),
      param_(param)
{
    setupCacheEnable_ = false;
    ASD_LOG(INFO) << "SelfAttentionKvCacheFusionOpsLlama13bRunner new, setupCacheEnable:" << setupCacheEnable_;
    BuildGraphWithMuls();
...
void SelfAttentionKvCacheFusionOpsLlama13bRunner::BuildGraphWithMuls()
{
...
void SelfAttentionKvCacheFusionOpsLlama13bRunner::SetKernelGrapModifyFunc()
{
    kernelGraph_.kernelGraphModifyFunc = [&](const RunnerVariantPack &runnerVariantPack) {
        if (typeid(SelfAttentionKvCacheFusionVariantPackParam) != runnerVariantPack.param.Type()) {
            ASD_LOG(FATAL) << "SelfAttentionKvCacheFusionOpsLlama13bRunner invalid type "
        ...
        ASD_LOG(INFO) << "SelfAttentionKvCacheFusionOpsLlama13bRunner SetOpDesc AsdOps::OpParam::Attention.headNum:"
