 ...
 */
#ifndef ALL_GATHER_HCCL_RUNNER_BUILDER_H
#define ALL_GATHER_HCCL_RUNNER_BUILDER_H
...
class AllGatherHcclRunnerBuilder : public RunnerBuilder {
public:
    AllGatherHcclRunnerBuilder(const AllGatherParam &param) : param_(param) {}
    virtual ~AllGatherHcclRunnerBuilder() = default;
