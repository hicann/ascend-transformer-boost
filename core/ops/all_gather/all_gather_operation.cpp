...
uint64_t AllGatherOperation::GetInTensorCount() const { return 1; }

uint64_t AllGatherOperation::GetOutTensorCount() const { return 1; }

AsdOps::Status AllGatherOperation::InferShapeImpl(const AsdOps::SVector<AsdOps::Tensor> &inTensors,
                                                  AsdOps::SVector<AsdOps::TensorDesc> &outTensorDescs) const
{
    outTensorDescs.at(0) = inTensors.at(0).desc;
    outTensorDescs.at(0).dims.insert(outTensorDescs.at(0).dims.begin(), param_.rankSize);
    return AsdOps::Status::OkStatus();
}

RunnerBuilder *AllGatherOperation::FindBestRunnerBuilder() const { return runnerBuilders_.at(0); }
} // namespace AclTransformer