...
class Model(PreTrainedModel):
    ...
    def forward(
        ...
        if past_key_values is not None:
            ...
            # key_length = input_ids.shape[1] + past_keys[0].shape[1]
            ...
            if np.allclose(acl_hidden_state.cpu(), hidden_states.cpu(), atol=0.02, rtol=0.02):
                print("*****equal result")
            else:
                print("!!!!not equal result", "acl", acl_hidden_state, "true", hidden_states)
