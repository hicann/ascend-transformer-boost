...
class DecoderLayer(nn.Module):
    ...
    def forward(
        ...
        if past_key_value is None:
            ...
            hidden_states, test_presentKey, test_presentValue = self.acl_llama_layer.execute(inputs)
        ...
        #     #NEW
        #     print("=========================================================================")
        #     print("[FUSION] test_llama7bOut shape:",test_llama7bOut[0].shape)
        #     print("=========================================================================")
        print("[FUSION] hidden_states shape:",hidden_states.shape)
        #     print("===========================compare hidden states==========================")
        print("[FUSION] hidden_states:\n",hidden_states)
        #     print("[FUSION] hidden_states_decoder:\n",test_llama7bOut[0])
            
        #     assert torch.allclose(
        #         test_llama7bOut[0], hidden_states, rtol=0.2, atol=0.02), 'not equal'
