...
class Attention(nn.Module):
    ...
    def __init__(self, config: BaiChuanConfig):
        ...
        self.acl_pos_operation = torch.classes.OperationTorch.OperationTorch("PositionEmbeddingOperation")
        self.acl_pos_operation.set_param(json.dumps({"headNum": self.num_heads, "model": "llama7b"}))
    ...
    def forward(
        ...
        testq, testk, testv = self.acl_pos_operation.execute([wpack, position_ids, cosTable, sinTable])
        cmpq = testq.permute(0, 2, 1, 3)
        cmpk = testk.permute(0, 2, 1, 3)

        # print("=========================================================================")
        # print("[FUSION] testq shape:",cmpq.shape)
        # print("=========================================================================")
        # print("[ORIGIN] query_states shape:",query_states.shape)
        # print("===========================compare hidden states==========================")
        # print("[ORIGIN] query_states:\n",query_states)
        # print("[FUSION] testq:\n",cmpq)
        # assert torch.allclose(query_states, cmpq, rtol=0.02, atol=0.02), 'q not equal'
        # print(">>> q get trough")

        # print("=========================================================================")
        # print("[FUSION] testk shape:",cmpk.shape)
        # print("=========================================================================")
        # print("[ORIGIN] key_states shape:",key_states.shape)
        # print("===========================compare hidden states==========================")
        # print("[ORIGIN] key_states:\n",key_states)
        # print("[FUSION] testk:\n",cmpk)
        assert torch.allclose(key_states, cmpk, rtol=0.02, atol=0.02), 'k not equal'
        print(">>> k get trough")

        # print("=========================================================================")
        # print("[FUSION] testv shape:",testv.shape)
        # print("=========================================================================")
        # print("[ORIGIN] v_origin shape:",v_origin.shape)
        # print("===========================compare hidden states==========================")
        # print("[ORIGIN] v_origin:\n",v_origin)
        # print("[FUSION] testv:\n",testv)
        # assert torch.allclose(v_origin, testv, rtol=0.02, atol=0.02), 'v not equal'
        # print(">>> v get trough")
...
class DecoderLayer(nn.Module):
    ...
    def forward(
        ...
        #         # weights_pack = weights[0]
        #         # weight_q, weight_k, weight_v = torch.split(weights_pack, self.hidden_size, dim=0)
        #         # weight_q = weight_q.npu_format_cast(29)
        #         # weight_k = weight_k.npu_format_cast(29)
        #         # weight_v = weight_v.npu_format_cast(29)
        ...
        #         # self.acl_weights.append(weight_k.npu())
        #         # self.acl_weights.append(torch.zeros(
        #         #     self.hidden_size).npu().half())
        #         # self.acl_weights.append(weight_v.npu())
        #         # self.acl_weights.append(torch.zeros(
        #         #     self.hidden_size).npu().half())
