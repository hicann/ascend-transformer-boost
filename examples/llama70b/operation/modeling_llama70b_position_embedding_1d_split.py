...
class LlamaAttention(nn.Module):
    ...
    def forward(
        ...
        if past_key_value is not None:
            ...
            acl_output = self.acl_position_embedding_1d_split_operation.execute(
                [acl_input, position_ids, cos, sin])
            assert torch.allclose(query_states.permute(
                0, 2, 1, 3), acl_output[0], rtol=0.02, atol=0.02), "Not equal"
            print("success")
