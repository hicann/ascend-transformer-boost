...
class BaseTransformer(torch.nn.Module):
    def __init__(self,
        ...
        self.acl_decoder_operation = torch.classes.ModelTorch.ModelTorch("Glm130BDecoderAllModel")
        self.acl_decoder_operation.set_param(acl_param)
        self.acl_encoder_operation = torch.classes.ModelTorch.ModelTorch("Glm130BDecoderAllModel")
    ...
    def forward(self, input_ids, position_ids, attention_mask, *,
        ...
        if self.checkpoint_activations:
            ...
            if self.weight_flag:
                ...
                self.acl_weights.append(acl_model_weights[0]) #final forward bias
