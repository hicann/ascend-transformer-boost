 ...
 */
#ifndef OPS_CHATGLM6B_CHATGLM6B_OPERATON_H
#define OPS_CHATGLM6B_CHATGLM6B_OPERATON_H
#include "acltransformer/graph_operation.h"

namespace AclTransformer {
struct ChatGlm6BParam {
...
class ChatGlm6BOperation : public GraphOperation {
public:
    ChatGlm6BOperation(ChatGlm6BParam &param);
    virtual ~ChatGlm6BOperation();
