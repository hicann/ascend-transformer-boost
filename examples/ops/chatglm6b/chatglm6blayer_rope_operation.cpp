 ...
 */
#include "chatglm6blayer_rope_operation.h"
...
enum Chatglm6BLayerRopeTensorId {
    IN_HIDDENSTATES = 0,
    IN_NORMWEIGHT,
    IN_NORMBIAS,
    IN_QKVMIXDWEIGHT,
...
ChatGlm6BLayerRopeOperation::ChatGlm6BLayerRopeOperation(const ChatGlm6BLayerParam &param)
    : GraphOperation("ChatGlm6BLayerRopeOperation"), param_(param)
{
...
ChatGlm6BLayerRopeOperation::~ChatGlm6BLayerRopeOperation() {}

uint64_t ChatGlm6BLayerRopeOperation::GetInTensorCount() const { return IN_TENSOR_COUNT; }

uint64_t ChatGlm6BLayerRopeOperation::GetOutTensorCount() const { return OUT_TENSOR_COUNT; }

AsdOps::Status ChatGlm6BLayerRopeOperation::InferShapeImpl(const AsdOps::SVector<AsdOps::Tensor> &inTensors,
