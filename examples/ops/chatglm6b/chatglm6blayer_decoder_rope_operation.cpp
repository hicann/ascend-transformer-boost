 ...
 */
#include "chatglm6blayer_decoder_rope_operation.h"
...
enum Chatglm6BLayerDecoderRopeTensorId {
    IN_HIDDENSTATES = 0,
    IN_NORMWEIGHT,
    IN_NORMBIAS,
    IN_QKVMIXDWEIGHT,
...
ChatGlm6BLayerDecoderRopeOperation::ChatGlm6BLayerDecoderRopeOperation(const ChatGlm6BLayerParam &param)
    : GraphOperation("ChatGlm6BLayerDecoderRopeOperation"), param_(param)
{
...
ChatGlm6BLayerDecoderRopeOperation::~ChatGlm6BLayerDecoderRopeOperation() {}

uint64_t ChatGlm6BLayerDecoderRopeOperation::GetInTensorCount() const { return IN_TENSOR_COUNT; }

uint64_t ChatGlm6BLayerDecoderRopeOperation::GetOutTensorCount() const { return OUT_TENSOR_COUNT; }

AsdOps::Status
ChatGlm6BLayerDecoderRopeOperation::InferShapeImpl(const AsdOps::SVector<AsdOps::Tensor> &inTensors,
