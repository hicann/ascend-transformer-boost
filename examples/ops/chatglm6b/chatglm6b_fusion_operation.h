 ...
 */
#ifndef OPS_CHATGLM6B_CHATGML6BFUSION_OPERATION_H
#define OPS_CHATGLM6B_CHATGML6BFUSION_OPERATION_H
#include "acltransformer/graph_operation.h"

namespace AclTransformer {
struct ChatGlm6BFusionParam {
    double layerNormEps = 0;
    int headNum = 0;
    float residualAddScale = 0;
};

class ChatGlm6BFusionOperation : public GraphOperation {
public:
    explicit ChatGlm6BFusionOperation(const ChatGlm6BFusionParam &param);
    virtual ~ChatGlm6BFusionOperation();
