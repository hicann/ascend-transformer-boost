 ...
 */
#ifndef OPS_BERT_BERT_OPERATION_H
#define OPS_BERT_BERT_OPERATION_H
...
class BertOperation : public GraphOperation {
public:
    BertOperation(const BertParam &param);
    virtual ~BertOperation();
