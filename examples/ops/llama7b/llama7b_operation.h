 ...
 */
#ifndef OPS_LLAMA7B_LLAMA7BB_OPERATION_H
#define OPS_LLAMA7B_LLAMA7BB_OPERATION_H
#include <string>
...
class Llam7BOperation : public GraphOperation {
public:
    Llam7BOperation(const Llam7BParam &param);
    virtual ~Llam7BOperation();
