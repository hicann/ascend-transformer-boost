...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def __init__(self, config: LlamaConfig):
        ...
        self.acl_decoder_model = torch.classes.ModelTorch.ModelTorch("Llama7BDecoderWithoutFusionModel")
        self.acl_decoder_param = json.dumps({"headNum": config.num_attention_heads // self.world_size, "rmsNormEps": config.rms_norm_eps,
                                             "dk": self.headSize, "layerNum": self.num_layers, "rank": rank, "rankSize": rankSize})
        print("acl_decoer_model param: ", self.acl_decoder_param)
    ...
    def forward(
        ...
        if self.weightFlag is False:
            ...
            for i in range(self.num_layers):
                ...
                weights_p.append(weights[5].npu().half())
