...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_path",
        default = "/data/models/baichuan2-7b",
        help="Location of Model weights, which contains model folders",
    )
    parser.add_argument(
        "--output_path",
        default ='/data/models/baichuan2-7b-part_model_2',
    ...
    tokenizer = LlamaTokenizer.from_pretrained(args.input_path, use_fast=False) #load the tokrnnizer
    ...
    model = LlamaForCausalLM.from_pretrained(args.input_path, torch_dtype=torch.float16) #load the raw model
