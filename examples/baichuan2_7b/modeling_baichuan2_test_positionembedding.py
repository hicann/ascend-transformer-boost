...
class LlamaAttention(nn.Module):
    ...
    def __init__(self, config: LlamaConfig):
        ...
        self.acl_pos_operation.set_param(json.dumps({"headNum": self.num_heads, "model": "baichuan2_7b", "dk": self.head_dim}))
    ...
    def forward(
        ...
        # [bsz, nh, t, hd]
        test_query = query_states.permute(0, 2, 1, 3)
        test_key = key_states.permute(0, 2, 1, 3)
        test_value = value_states.permute(0, 2, 1, 3)

        acl_cos = cos.squeeze(1).squeeze(0)
        acl_sin = sin.squeeze(1).squeeze(0)
        ...
        query_states = acl_query
        key_states = acl_key
        value_states = acl_value
