 ...
 */
#include "chatglm6bmodel_encoder_rope_torch.h"
...
#include "examples/ops/chatglm6b/chatglm6blayer_encoder_rope_operation.h"

const size_t WEIGHT_COUNT_PER_LAYER = 12;

ChatGlm6BModelEncoderRopeTorch::ChatGlm6BModelEncoderRopeTorch()
{
    ASD_LOG(INFO) << "ChatGlm6BModelEncoderRopeTorch::ChatGlm6BModelEncoderRopeTorch, TASK_QUEUE_ENABLE:"
...
void ChatGlm6BModelEncoderRopeTorch::SetParam(std::string param)
{
    ...
    for (int i = 0; i < modelParam_.layerNum; ++i) {
        ...
        AclTransformer::Operation *op = new AclTransformer::ChatGlm6BLayerEncoderRopeOperation(opParam);
...
void ChatGlm6BModelEncoderRopeTorch::SetWeight(std::vector<torch::Tensor> weightTensors)
{
...
ChatGlm6BModelEncoderRopeTorch::Execute(torch::Tensor hiddenStateTensor, torch::Tensor positionIdTensor,
...
void ChatGlm6BModelEncoderRopeTorch::ExecuteOut(torch::Tensor hiddenStateTensor, torch::Tensor positionIdTensor,
                                                torch::Tensor cosTableTensor, torch::Tensor sinTableTensor,
                                                torch::Tensor attentionMaskTensor, torch::Tensor seqLen,
...
void ChatGlm6BModelEncoderRopeTorch::ExecuteOutImpl(torch::Tensor &hiddenStateTensor, torch::Tensor &positionIdTensor,
                                                    torch::Tensor &cosTableTensor, torch::Tensor &sinTableTensor,
                                                    torch::Tensor &attentionMaskTensor, torch::Tensor &seqLen,
                                                    torch::Tensor &outTensor,
...
void ChatGlm6BModelEncoderRopeTorch::BuildVariantPack(int layerId, std::vector<torch::Tensor> &atInTensors,
...
void ChatGlm6BModelEncoderRopeTorch::ExecuteSingleOperation(int layerId, std::vector<torch::Tensor> &opAtInTensors,
                                                            torch::Tensor &outTensor, torch::Tensor &presendKeyTensor,
                                                            torch::Tensor &presentValueTensor, bool newOut)
{
...
TORCH_LIBRARY(ChatGlm6BModelEncoderRopeTorch, m)
{
    m.class_<ChatGlm6BModelEncoderRopeTorch>("ChatGlm6BModelEncoderRopeTorch")
        .def(torch::init<>())
        .def("set_param", &ChatGlm6BModelEncoderRopeTorch::SetParam)
        .def("set_weight", &ChatGlm6BModelEncoderRopeTorch::SetWeight)
        .def("execute", &ChatGlm6BModelEncoderRopeTorch::Execute)
        .def("execute_out", &ChatGlm6BModelEncoderRopeTorch::ExecuteOut);
}