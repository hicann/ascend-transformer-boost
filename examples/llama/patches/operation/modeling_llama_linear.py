...
class LlamaAttention(nn.Module):
    ...
    def __init__(self, config: LlamaConfig):
        ...
        self.linear_operation = torch.classes.OperationTorch.OperationTorch(
            "LinearOperation")
        self.linear_operation.set_param(json.dumps(
    ...
    def forward(
        ...
        linear_bias = torch.zeros(self.q_proj.weight.shape[0]).npu(
