...
model_bloom = "/home/mny/model/bloom/"
tokenizer = AutoTokenizer.from_pretrained(model_bloom, use_fast=False)
model = AutoModelForCausalLM.from_pretrained(model_bloom).half()
...
for batch_size, seq_len in test_cases:
  ...
  torch.save(output, "./pre/npu_output.pt")
  print(model.device)
