...
function fn_main()
{
    ...
    case "${RUN_OPTION}" in
        "--cut")
            ...
            ;;
        "--performance")
            torchrun --nproc_per_node 2 --master_port 20000 $SCRIPT_DIR/main_performance.py --parallel
            ;;
        # "--webdemo")
        #     unset https_proxy
        #     unset http_proxy
        ...
        #     ;;
        "--zhipu")
            torchrun --nproc_per_node 2 --master_port 20000 $SCRIPT_DIR/zhipu_test.py --parallel
            ;;
        # "--profiling")
