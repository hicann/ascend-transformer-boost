...
lg.basicConfig(filename='glm_mlp.log', level=lg.INFO, format=LOG_FORMAT, datefmt=DATE_FORMAT)
...
class MLP(torch.nn.Module):
    ...
    def __init__(self, config: ChatGLMConfig, device=None):
        ...
        self.mlp_operation.set_param(json.dumps({"model":"chatglm2_6b"}))
        # +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    def forward(self, hidden_states):
        ...
        # assert torch.allclose(output, output_exec, atol=0.02, rtol=0.02), "MLP Not equal"
        return output_exec
