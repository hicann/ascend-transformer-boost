...
# ============================================================================================================
        ...
        self.acl_decoder_operation = torch.classes.OperationTorch.OperationTorch(
            "ChatGlm2FusionLayerDecoderOperation")
    ...
    def forward(
        ...
        if kv_cache is None:
            ...
            self.input_full.append(seq_len_tensor)

            # stream = torch.npu.current_stream()
            # stream.synchronize()
            # prof = torch.npu.profile('/data/models/chatglm2_6b/profiling/full')
            # prof.__enter__()
            ...
            # stream = torch.npu.current_stream()
            # stream.synchronize()
            # prof = torch.npu.profile('/data/models/chatglm2_6b/profiling/increment')
            # prof.__enter__()
        ...
        # #torch.save(hidden_states.cpu(), './tensors/torch/hidden_states.pth')
        # #torch.save(layernorm_output.cpu(), './tensors/torch/layernorm_output.pth')
        ...
        #     use_cache=use_cache
        # )
        # #torch.save(attention_output.cpu(), './tensors/torch/self_attention.pth')
        ...
        # #torch.save(layernorm_output.cpu(), './tensors/torch/layernorm_output1.pth')

        # # MLP.
        # mlp_output = self.mlp(layernorm_output)
        # #torch.save(mlp_output.cpu(), './tensors/torch/mlp_output.pth')
        ...
        # if not torch.allclose(output, test_glmBlockOut, rtol=0.05, atol=0.05):
        #     print(output)
        #     print("=====================================================================================")
        #     print(test_glmBlockOut)
        #     print(output == test_glmBlockOut)
        # else:
        #     print("equal")
