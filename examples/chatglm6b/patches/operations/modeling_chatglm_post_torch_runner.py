...
class ChatGLMForConditionalGeneration(ChatGLMPreTrainedModel):
    ...
    def stream_generate(
        ...
        self.post_operation = torch.classes.OperationTorch.OperationTorch("PostOperation")

        self.post_operation.set_param(json.dumps({"top_p": 0.7, "top_k": 50, "temperature": 0.95, "min_tokens_to_keep": 1}))
