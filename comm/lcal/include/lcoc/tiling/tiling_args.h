...
namespace Lcal {
    ...
    constexpr int32_t L1AB_PINGPONG_BUFFER_LEN_FP16 = 131072;
    ...
    constexpr int32_t ALLREDUCE_LENPERLOOP_DEFAULT = 5120;
    ...
    struct CoCTiling {
        ...
        int32_t extraCommNpuSplit = -1;
        int32_t extraCommDataSplit = -1;
        int32_t extraCommDirect = -1;
        int32_t extraLenPerLoop = -1;
        int32_t splitK = -1;
