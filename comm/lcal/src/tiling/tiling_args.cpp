...
namespace Lcal {
    const char* CoCTilingData::ToString()
    {
        std::string str =
            ...
            ", extraLenPerLoop=" + std::to_string(extraLenPerLoop) + ", splitK=" + std::to_string(splitK) +
            ", write2OtherRank=" + std::to_string(write2OtherRank) +
            ", withSerialMode=" + std::to_string(withSerialMode) + ", is91093=" + std::to_string(is91093);
        return str.data();
    }
