...
namespace Lcal {
    ...
    static std::map<int, std::vector<std::vector<int>>> g_allreduceFourRankInT8M0Map = {
        {256, {{-1, 3072, -1, 2147483647, -1, 768}}}
    };

    static std::map<int, std::vector<std::vector<int>>> g_allreduceFourRankInT8DatasplitMap = {
        {1, {{-1, 768, -1, 2147483647, -1, 768}}},
        {2, {{-1, 1536, -1, 2147483647, 768, 1536}}},
        {4, {{768, 10010, -1, 2147483647, -1, 768}}},
        {8,
         {{1536, 10010, -1, 2147483647, 768, 1536},
          {10010, 2147483647, 3072, 2147483647, -1, 768},
          {-1, 19680, 7170, 2147483647, 1536, 7424},
          {-1, 7350, 7170, 2147483647, 7424, 2147483647}}},
        {16,
         {{10010, 2147483647, 3072, 2147483647, 768, 1536},
          {19680, 2147483647, 7170, 2147483647, 1536, 7424},
          {7350, 2147483647, 7170, 2147483647, 7424, 2147483647}}},
        {32, {{10010, 2147483647, -1, 3072, -1, 1536}, {-1, 2147483647, -1, 7170, 1536, 2147483647}}}
    };

    static std::map<int, std::vector<std::vector<int>>> g_allreduceFourRankInT8PvalueMap = {
        {1, {{-1, 10010, -1, 2147483647, -1, 768}, {-1, 5148, -1, 2147483647, 768, 1536}}},
        {2,
         {{5148, 10010, -1, 2147483647, 768, 1536},
          {10010, 2147483647, 3072, 2147483647, -1, 768},
          {-1, 19680, 7170, 2147483647, 1536, 7424},
          {-1, 7350, 7170, 2147483647, 7424, 2147483647}}},
        {4,
         {{19680, 2147483647, 7170, 2147483647, 1536, 7424},
          {7350, 2147483647, 7170, 2147483647, 7424, 2147483647},
          {10010, 2147483647, 3072, 2147483647, 768, 1536}}},
        {6, {{10010, 36980, -1, 3072, -1, 1536}}},
        {8, {{36980, 2147483647, -1, 3072, -1, 1536}, {-1, 2147483647, -1, 7170, 1536, 2147483647}}}
    };

    static std::map<int, std::vector<std::vector<int>>> g_allreduceFourRankInT8UbmovenumMap = {
        {20, {{53340, 2147483647, 7170, 2147483647, -1, 3072}}},
        {30,
         {{-1, 53340, -1, 2147483647, -1, 3072},
          {53340, 2147483647, -1, 4608, -1, 768},
          {53340, 2147483647, 4608, 7170, -1, 3072},
          {-1, 7196, -1, 2147483647, 3072, 2147483647},
          {10010, 15412, -1, 2147483647, 3072, 2147483647},
          {15412, 2147483647, 5634, 2147483647, 3072, 2147483647}}},
        {40,
         {{53340, 2147483647, -1, 4608, 768, 3072},
          {7196, 10010, -1, 2147483647, 3072, 2147483647},
